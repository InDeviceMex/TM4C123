...
#define EEPROM_BITBANDING      (((EEPROM_BITBANDING_TypeDef*)(EEPROM_BASE_BITBANDING+(EEPROM_OFFSET*32))))
...
#define EEPROM_EEDONE_WORKING_BITBANDING     (*((volatile const uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEDONE_OFFSET)*32)+(EEPROM_EEDONE_R_WORKING_BIT*4))))
#define EEPROM_EEDONE_WKERASE_BITBANDING     (*((volatile const uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEDONE_OFFSET)*32)+(EEPROM_EEDONE_R_WKERASE_BIT*4))))
#define EEPROM_EEDONE_WKCOPY_BITBANDING      (*((volatile const uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEDONE_OFFSET)*32)+(EEPROM_EEDONE_R_WKCOPY_BIT*4))))
#define EEPROM_EEDONE_NOPERM_BITBANDING      (*((volatile const uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEDONE_OFFSET)*32)+(EEPROM_EEDONE_R_NOPERM_BIT*4))))
#define EEPROM_EEDONE_WRBUSY_BITBANDING      (*((volatile const uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEDONE_OFFSET)*32)+(EEPROM_EEDONE_R_WRBUSY_BIT*4))))
...
#define EEPROM_EESUPP_START_BITBANDING       (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EESUPP_OFFSET)*32)+(EEPROM_EESUPP_R_START_BIT*4))))
#define EEPROM_EESUPP_EREQ_BITBANDING        (*((volatile const uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EESUPP_OFFSET)*32)+(EEPROM_EESUPP_R_EREQ_BIT*4))))
#define EEPROM_EESUPP_ERETRY_BITBANDING      (*((volatile const uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EESUPP_OFFSET)*32)+(EEPROM_EESUPP_R_ERETRY_BIT*4))))
#define EEPROM_EESUPP_PRETRY_BITBANDING      (*((volatile const uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EESUPP_OFFSET)*32)+(EEPROM_EESUPP_R_PRETRY_BIT*4))))
...
#define EEPROM_EEHIDE_H1_BITBANDING       (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H1_BIT*4))))
#define EEPROM_EEHIDE_H2_BITBANDING       (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H2_BIT*4))))
#define EEPROM_EEHIDE_H3_BITBANDING       (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H3_BIT*4))))
#define EEPROM_EEHIDE_H4_BITBANDING       (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H4_BIT*4))))
#define EEPROM_EEHIDE_H5_BITBANDING       (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H5_BIT*4))))
#define EEPROM_EEHIDE_H6_BITBANDING       (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H6_BIT*4))))
#define EEPROM_EEHIDE_H7_BITBANDING       (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H7_BIT*4))))
#define EEPROM_EEHIDE_H8_BITBANDING       (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H8_BIT*4))))
#define EEPROM_EEHIDE_H9_BITBANDING       (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H9_BIT*4))))
#define EEPROM_EEHIDE_H10_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H10_BIT*4))))
#define EEPROM_EEHIDE_H11_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H11_BIT*4))))
#define EEPROM_EEHIDE_H12_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H12_BIT*4))))
#define EEPROM_EEHIDE_H13_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H13_BIT*4))))
#define EEPROM_EEHIDE_H14_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H14_BIT*4))))
#define EEPROM_EEHIDE_H15_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H15_BIT*4))))
#define EEPROM_EEHIDE_H16_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H16_BIT*4))))
#define EEPROM_EEHIDE_H17_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H17_BIT*4))))
#define EEPROM_EEHIDE_H18_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H18_BIT*4))))
#define EEPROM_EEHIDE_H19_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H19_BIT*4))))
#define EEPROM_EEHIDE_H20_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H20_BIT*4))))
#define EEPROM_EEHIDE_H21_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H21_BIT*4))))
#define EEPROM_EEHIDE_H22_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H22_BIT*4))))
#define EEPROM_EEHIDE_H23_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H23_BIT*4))))
#define EEPROM_EEHIDE_H24_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H24_BIT*4))))
#define EEPROM_EEHIDE_H25_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H25_BIT*4))))
#define EEPROM_EEHIDE_H26_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H26_BIT*4))))
#define EEPROM_EEHIDE_H27_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H27_BIT*4))))
#define EEPROM_EEHIDE_H28_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H28_BIT*4))))
#define EEPROM_EEHIDE_H29_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H29_BIT*4))))
#define EEPROM_EEHIDE_H30_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H30_BIT*4))))
#define EEPROM_EEHIDE_H31_BITBANDING      (*((volatile uint32_t *)(EEPROM_BASE_BITBANDING+((EEPROM_OFFSET+EEPROM_EEHIDE_OFFSET)*32)+(EEPROM_EEHIDE_R_H31_BIT*4))))
