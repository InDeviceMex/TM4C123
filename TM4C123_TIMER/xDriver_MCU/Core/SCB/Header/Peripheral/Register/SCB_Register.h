...
#include <xDriver_MCU/Core/SCB/Header/Peripheral/Register/RegisterDefines/SCB_RegisterDefines.h>
#include <xDriver_MCU/Core/SCB/Header/Peripheral/Register/SCB_RegisterPeripheral.h>
