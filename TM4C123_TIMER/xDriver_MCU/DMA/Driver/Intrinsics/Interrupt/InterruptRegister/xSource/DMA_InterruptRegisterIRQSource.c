...
{
    DMA_nCH_INTERRUPT_SOURCE u32InterruptSourceType=DMA_enCH_INTERRUPT_SOURCE_PERIPHERAL;
    ...
    if((uint32_t)pfIrqSourceHandler !=0u)
    {
        ...
        {
            u32InterruptSourceType=DMA_enCH_INTERRUPT_SOURCE_SOFTWARE;
        }

        u32IrqSourceHandler=((uint32_t)pfIrqSourceHandler|1u);
        DMA_CH__vIRQSourceHandler[u32InterruptSourceType][enDMAModule]= (void (*) (void))u32IrqSourceHandler;
    }
}
