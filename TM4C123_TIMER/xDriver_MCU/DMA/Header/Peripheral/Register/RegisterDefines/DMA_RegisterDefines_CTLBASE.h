...
/*--------*/
#define DMA_DMACTLBASE_R_ADDR_MASK     ((uint32_t)0xFFFFFC00u)
#define DMA_DMACTLBASE_R_ADDR_BIT      ((uint32_t)10u)

#define DMA_DMACTLBASE_ADDR_MASK       ((uint32_t)0x003FFFFFu)
/*--------*/
