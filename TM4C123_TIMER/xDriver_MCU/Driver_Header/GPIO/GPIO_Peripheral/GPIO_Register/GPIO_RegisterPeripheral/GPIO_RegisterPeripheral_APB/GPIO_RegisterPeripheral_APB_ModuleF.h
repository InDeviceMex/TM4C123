...
******************************************************************************************/
/* GPIOF APB AMSEL*/
#define GPIOF_APB_GPIOFMSEL                  (((GPIOFMSEL_TypeDef*)     (GPIOF_APB_BASE+GPIO_GPIOFMSEL_OFFSET)))
#define GPIOF_APB_GPIOFMSEL_R                (*((volatile uint32_t *)  (GPIOF_APB_BASE+GPIO_GPIOFMSEL_OFFSET)))
