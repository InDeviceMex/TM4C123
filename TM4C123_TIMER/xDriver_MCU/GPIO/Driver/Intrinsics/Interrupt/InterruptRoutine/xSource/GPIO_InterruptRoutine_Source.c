...
void (*GPIO__vIRQSourceHandler[(uint32_t)GPIO_enPORT_MAX+1u][(uint32_t)GPIO_enPIN_NUMBER_MAX+1u]) (void)={{&GPIO_vIRQSourceHandler_Dummy,&GPIO_vIRQSourceHandler_Dummy,&GPIO_vIRQSourceHandler_Dummy,&GPIO_vIRQSourceHandler_Dummy,&GPIO_vIRQSourceHandler_Dummy,&GPIO_vIRQSourceHandler_Dummy,&GPIO_vIRQSourceHandler_Dummy,&GPIO_vIRQSourceHandler_Dummy},
