...
void I2C__vRegisterIRQSourceMasterHandler(void (*pfIrqSourceHandler) (void),I2C_nMODULE enModule, I2C_nMASTER_INTERRUPT enInterruptSource)
{
...
void I2C__vRegisterIRQSourceSlaveHandler(void (*pfIrqSourceHandler) (void),I2C_nMODULE enModule, I2C_nSLAVE_INTERRUPT enInterruptSource)
{
    uint32_t u32Module = 0UL;
    uint32_t u32InterruptSource = 0UL;
    if(0UL != (uint32_t) pfIrqSourceHandler)
