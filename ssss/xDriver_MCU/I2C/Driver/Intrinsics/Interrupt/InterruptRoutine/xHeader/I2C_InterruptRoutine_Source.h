...
extern void (*I2C__vIRQSourceMasterHandler[(uint32_t) I2C_enMODULE_MAX][(uint32_t) I2C_enMASTER_INTERRUPT_MAX]) (void);
extern void (*I2C__vIRQSourceSlaveHandler[(uint32_t) I2C_enMODULE_MAX][(uint32_t) I2C_enSLAVE_INTERRUPT_MAX]) (void);
