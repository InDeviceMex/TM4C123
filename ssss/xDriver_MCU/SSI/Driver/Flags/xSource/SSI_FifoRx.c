...
SSI_nFIFO_EMPTY SSI__enIsFifoReceiveEmpty(SSI_nMODULE enModule)
{
    ...
    SSI__enReadRegister(enModule, SSI_SSISR_OFFSET, &u32Reg, SSI_SSISR_RNE_MASK, SSI_SSISR_R_RNE_BIT);
...
{
    uint32_t u32Reg = 0xFFFFFFFFUL;
    SSI__enReadRegister(enModule, SSI_SSISR_OFFSET, &u32Reg, SSI_SSISR_RFF_MASK, SSI_SSISR_R_RFF_BIT);
