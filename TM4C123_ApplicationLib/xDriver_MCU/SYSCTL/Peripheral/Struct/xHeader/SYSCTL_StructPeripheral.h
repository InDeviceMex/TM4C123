...
typedef volatile struct
{
    ...
    union
    {
        volatile uint32_t HBCTL;
        GPIOHBCTL_TypeDef HBCTL_Bit;
    };
    union
    {
    ...
    const uint32_t reserved14 [3UL];
    union
    {
        volatile uint32_t NVMSTAT;
        NVMSTAT_TypeDef NVMSTAT_Bit;
    };
    const uint32_t reserved15 [4UL];
    union
    {
    ...
    const uint32_t reserved19 [60UL];
    union
    {
        volatile const uint32_t PP [24UL];
        const PERIPHERAL_TypeDef PP_Bit [24UL];
    };
    const uint32_t reserved20 [40UL];
    union
    {
    ...
    const uint32_t reserved21 [60UL];
    union
    {
        volatile uint32_t SR [24UL];
        PERIPHERAL_TypeDef SR_Bit [24UL];
    };
    const uint32_t reserved22 [40UL];
    union
    {
        volatile uint32_t RCGC [24UL];
        PERIPHERAL_TypeDef RCGC_Bit [24UL];
    };
    const uint32_t reserved23 [40UL];
    union
    {
        volatile uint32_t SCGC [24UL];
        PERIPHERAL_TypeDef SCGC_Bit [24UL];
    };
    const uint32_t reserved24 [40UL];
    union
    {
        volatile uint32_t DCGC [24UL];
        PERIPHERAL_TypeDef DCGC_Bit [24UL];
    };
    const uint32_t reserved25 [104UL];
    union
    {
        volatile uint32_t PR [24UL];
        PERIPHERAL_TypeDef PR_Bit [24UL];
    };
}SYSCTL_TypeDef;
