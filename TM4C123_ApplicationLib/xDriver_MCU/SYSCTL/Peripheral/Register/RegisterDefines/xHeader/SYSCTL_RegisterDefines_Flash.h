...
******************************************************************************************/
/*--------*/
#define SYSCTL_FMPRE0_ALIAS_R_READ_ENABLE_MASK    ((uint32_t) 0xFFFFFFFFUL)
#define SYSCTL_FMPRE0_ALIAS_R_READ_ENABLE_BIT    (0UL)

#define SYSCTL_FMPRE0_ALIAS_READ_ENABLE_MASK    ((uint32_t) 0xFFFFFFFFUL)
/*--------*/
...
******************************************************************************************/
/*--------*/
#define SYSCTL_FMPPE0_ALIAS_R_PROG_ENABLE_MASK    ((uint32_t) 0xFFFFFFFFUL)
#define SYSCTL_FMPPE0_ALIAS_R_PROG_ENABLE_BIT    (0UL)

#define SYSCTL_FMPPE0_ALIAS_PROG_ENABLE_MASK    ((uint32_t) 0xFFFFFFFFUL)
/*--------*/
