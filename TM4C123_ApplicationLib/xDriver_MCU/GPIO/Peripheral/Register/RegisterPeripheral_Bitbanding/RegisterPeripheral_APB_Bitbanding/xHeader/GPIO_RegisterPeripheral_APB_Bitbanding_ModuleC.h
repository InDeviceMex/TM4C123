 ...
 ******************************************************************************************/
/* GPIOC APB AFSEL*/
#define GPIOC_BITBANDING_CFSEL    ((BITBANDING_GPIOCFSEL_TypeDef*) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CFSEL_OFFSET) * 32UL)))

/* GPIOC APB AFSEL BITBANDING*/
#define GPIOC_BITBANDING_CFSEL_AFSEL0    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CFSEL_OFFSET) * 32UL) + (GPIO_CFSEL_R_AFSEL0_BIT * 4UL))))
#define GPIOC_BITBANDING_CFSEL_AFSEL1    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CFSEL_OFFSET) * 32UL) + (GPIO_CFSEL_R_AFSEL1_BIT * 4UL))))
#define GPIOC_BITBANDING_CFSEL_AFSEL2    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CFSEL_OFFSET) * 32UL) + (GPIO_CFSEL_R_AFSEL2_BIT * 4UL))))
#define GPIOC_BITBANDING_CFSEL_AFSEL3    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CFSEL_OFFSET) * 32UL) + (GPIO_CFSEL_R_AFSEL3_BIT * 4UL))))
#define GPIOC_BITBANDING_CFSEL_AFSEL4    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CFSEL_OFFSET) * 32UL) + (GPIO_CFSEL_R_AFSEL4_BIT * 4UL))))
#define GPIOC_BITBANDING_CFSEL_AFSEL5    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CFSEL_OFFSET) * 32UL) + (GPIO_CFSEL_R_AFSEL5_BIT * 4UL))))
#define GPIOC_BITBANDING_CFSEL_AFSEL6    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CFSEL_OFFSET) * 32UL) + (GPIO_CFSEL_R_AFSEL6_BIT * 4UL))))
#define GPIOC_BITBANDING_CFSEL_AFSEL7    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CFSEL_OFFSET) * 32UL) + (GPIO_CFSEL_R_AFSEL7_BIT * 4UL))))
 ...
 ******************************************************************************************/
/* GPIOC APB AMSEL*/
#define GPIOC_BITBANDING_CMSEL    ((BITBANDING_GPIOCMSEL_TypeDef*) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CMSEL_OFFSET) * 32UL)))

/* GPIOC APB AMSEL BITBANDING*/
#define GPIOC_BITBANDING_CMSEL_AMSEL0    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CMSEL_OFFSET) * 32UL) + (GPIO_CMSEL_R_AMSEL0_BIT * 4UL))))
#define GPIOC_BITBANDING_CMSEL_AMSEL1    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CMSEL_OFFSET) * 32UL) + (GPIO_CMSEL_R_AMSEL1_BIT * 4UL))))
#define GPIOC_BITBANDING_CMSEL_AMSEL2    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CMSEL_OFFSET) * 32UL) + (GPIO_CMSEL_R_AMSEL2_BIT * 4UL))))
#define GPIOC_BITBANDING_CMSEL_AMSEL3    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CMSEL_OFFSET) * 32UL) + (GPIO_CMSEL_R_AMSEL3_BIT * 4UL))))
#define GPIOC_BITBANDING_CMSEL_AMSEL4    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CMSEL_OFFSET) * 32UL) + (GPIO_CMSEL_R_AMSEL4_BIT * 4UL))))
#define GPIOC_BITBANDING_CMSEL_AMSEL5    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CMSEL_OFFSET) * 32UL) + (GPIO_CMSEL_R_AMSEL5_BIT * 4UL))))
#define GPIOC_BITBANDING_CMSEL_AMSEL6    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CMSEL_OFFSET) * 32UL) + (GPIO_CMSEL_R_AMSEL6_BIT * 4UL))))
#define GPIOC_BITBANDING_CMSEL_AMSEL7    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CMSEL_OFFSET) * 32UL) + (GPIO_CMSEL_R_AMSEL7_BIT * 4UL))))
 ...
 ******************************************************************************************/
/* GPIOC APB ADCEN*/
#define GPIOC_BITBANDING_CDCCTL    ((BITBANDING_GPIOCDCCTL_TypeDef*) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CDCCTL_OFFSET) * 32UL)))

/* GPIOC APB ADCEN BITBANDING*/
#define GPIOC_BITBANDING_CDCCTL_ADCEN0    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CDCCTL_OFFSET) * 32UL) + (GPIO_CDCCTL_R_ADCEN0_BIT * 4UL))))
#define GPIOC_BITBANDING_CDCCTL_ADCEN1    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CDCCTL_OFFSET) * 32UL) + (GPIO_CDCCTL_R_ADCEN1_BIT * 4UL))))
#define GPIOC_BITBANDING_CDCCTL_ADCEN2    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CDCCTL_OFFSET) * 32UL) + (GPIO_CDCCTL_R_ADCEN2_BIT * 4UL))))
#define GPIOC_BITBANDING_CDCCTL_ADCEN3    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CDCCTL_OFFSET) * 32UL) + (GPIO_CDCCTL_R_ADCEN3_BIT * 4UL))))
#define GPIOC_BITBANDING_CDCCTL_ADCEN4    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CDCCTL_OFFSET) * 32UL) + (GPIO_CDCCTL_R_ADCEN4_BIT * 4UL))))
#define GPIOC_BITBANDING_CDCCTL_ADCEN5    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CDCCTL_OFFSET) * 32UL) + (GPIO_CDCCTL_R_ADCEN5_BIT * 4UL))))
#define GPIOC_BITBANDING_CDCCTL_ADCEN6    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CDCCTL_OFFSET) * 32UL) + (GPIO_CDCCTL_R_ADCEN6_BIT * 4UL))))
#define GPIOC_BITBANDING_CDCCTL_ADCEN7    (*((volatile uint32_t *) (GPIO_BITBANDING_BASE + ((GPIOC_OFFSET + GPIO_CDCCTL_OFFSET) * 32UL) + (GPIO_CDCCTL_R_ADCEN7_BIT * 4UL))))
