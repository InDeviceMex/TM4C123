...
{
    I2C__vWriteRegister(enModule, I2C_I2CMCR_OFFSET, (uint32_t) enGlitchEnableArg, I2C_I2CMCR_GFE_MASK, I2C_I2CMCR_R_GFE_BIT);
}

I2C_nGLITCH I2C__enGetEnableGlitchFilter(I2C_nMODULE enModule)
{
    I2C_nGLITCH enGlitchClockReg = I2C_enGLITCH_UNDEF;
    I2C__enReadRegister(enModule, I2C_I2CMCR_OFFSET, (uint32_t*) &enGlitchClockReg, I2C_I2CMCR_GFE_MASK, I2C_I2CMCR_R_GFE_BIT);
    return enGlitchClockReg;
}

void I2C__vSetGlitchFilter(I2C_nMODULE enModule, I2C_nGLITCH_CLOCK enGlitchClockArg)
{
    I2C__vWriteRegister(enModule, I2C_I2CMCR2_OFFSET, (uint32_t) enGlitchClockArg, I2C_I2CMCR2_GFPW_MASK, I2C_I2CMCR2_R_GFPW_BIT);
}

I2C_nGLITCH_CLOCK I2C__enGetGlitchFilter(I2C_nMODULE enModule)
{
    I2C_nGLITCH_CLOCK enGlitchClockReg = I2C_enGLITCH_CLOCK_UNDEF;
    I2C__enReadRegister(enModule, I2C_I2CMCR2_OFFSET, (uint32_t*) &enGlitchClockReg, I2C_I2CMCR2_GFPW_MASK, I2C_I2CMCR2_R_GFPW_BIT);
    return enGlitchClockReg;
}
