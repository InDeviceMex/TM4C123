...
************************************ 9 GPIOHBCTL *********************************************
******************************************************************************************/
#define SYSCTL_BITBANDING_GPIOBHCTL    ((BITBANDING_GPIOBHCTL_TypeDef*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_GPIOBHCTL_OFFSET) * 32UL)))

#define SYSCTL_BITBANDING_GPIOHBCTL_PORTA (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_GPIOHBCTL_OFFSET) * 32UL) + (SYSCTL_GPIOHBCTL_R_PORTA_BIT * 4UL))))
#define SYSCTL_BITBANDING_GPIOHBCTL_PORTB (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_GPIOHBCTL_OFFSET) * 32UL) + (SYSCTL_GPIOHBCTL_R_PORTB_BIT * 4UL))))
#define SYSCTL_BITBANDING_GPIOHBCTL_PORTC (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_GPIOHBCTL_OFFSET) * 32UL) + (SYSCTL_GPIOHBCTL_R_PORTC_BIT * 4UL))))
#define SYSCTL_BITBANDING_GPIOHBCTL_PORTD (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_GPIOHBCTL_OFFSET) * 32UL) + (SYSCTL_GPIOHBCTL_R_PORTD_BIT * 4UL))))
#define SYSCTL_BITBANDING_GPIOHBCTL_PORTE (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_GPIOHBCTL_OFFSET) * 32UL) + (SYSCTL_GPIOHBCTL_R_PORTE_BIT * 4UL))))
#define SYSCTL_BITBANDING_GPIOHBCTL_PORTF (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_GPIOHBCTL_OFFSET) * 32UL) + (SYSCTL_GPIOHBCTL_R_PORTF_BIT * 4UL))))
...
#define SYSCTL_BITBANDING_BOOTCFG_EN    (*((volatile uint32_t*) (SYSCTL_BITBANDING_BASE + ((SYSCTL_OFFSET + SYSCTL_BOOTCFG_OFFSET) * 32UL) + (SYSCTL_BOOTCFG_R_EN_BIT * 4UL))))
