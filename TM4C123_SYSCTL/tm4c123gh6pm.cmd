...
MEMORY
{
    FLASH_CODE (RX) 	: origin = 0x00000000, length = 0x00010000
    FLASH_CONST (R) 	: origin = 0x00010000, length = 0x00030000
    SRAM_CODE (RWX) 	: origin = 0x20000000, length = 0x00000400
    SRAM_VARIABLE (RW) 	: origin = 0x20000400, length = 0x00006800
...
__STACK_TOP = __stack + 0x00000200;
