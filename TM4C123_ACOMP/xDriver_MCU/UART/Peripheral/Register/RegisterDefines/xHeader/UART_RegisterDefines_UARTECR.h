...
/*--------*/
#define UART_UARTECR_R_DATA_MASK    ((uint32_t) 0x000000FFUL)
#define UART_UARTECR_R_DATA_BIT    ((uint32_t) 0UL)
#define UART_UARTECR_R_DATA_CLEAR    ((uint32_t) 0x000000FFUL)

#define UART_UARTECR_DATA_MASK    ((uint32_t) 0x000000FFUL)
#define UART_UARTECR_DATA_CLEAR    ((uint32_t) 0x000000FFUL)
/*--------*/
