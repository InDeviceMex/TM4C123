...
typedef enum
{
    UART_enINT_CLEAR_TO_SEND = 0x2UL,
    UART_enINT_RECEIVE = 0x10UL,
    UART_enINT_TRANSMIT = 0x20UL,
    UART_enINT_RECEIVE_TIMEOUT = 0x40UL,
    UART_enINT_FRAME_ERROR = 0x80UL,
    UART_enINT_PARITY_ERROR = 0x100UL,
    UART_enINT_BREAK_ERROR = 0x200UL,
    UART_enINT_OVERRUN_ERROR = 0x400UL,
    UART_enINT_BIT9_MODE = 0x1000UL,
    UART_enINT_ALL = 0x17F2UL,
}UART_nINT;
