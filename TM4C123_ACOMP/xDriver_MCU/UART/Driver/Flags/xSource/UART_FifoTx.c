...
UART_nFIFO_EMPTY UART__enIsFifoTransmitEmpty(UART_nMODULE enModule)
{
    ...
    UART__enReadRegister(enModule, UART_UARTFR_OFFSET, &u32Reg, UART_UARTFR_TXFE_MASK, UART_UARTFR_R_TXFE_BIT);
...
{
    uint32_t u32Reg = 0xFFFFFFFFUL;
    UART__enReadRegister(enModule, UART_UARTFR_OFFSET, &u32Reg, UART_UARTFR_TXFF_MASK, UART_UARTFR_R_TXFF_BIT);
