...
void UART1__vIRQVectorHandler(void)
{
    ...
    if(0UL != u32RegDMAEn)
    {
        ...
        if(0UL != u32RegDMAOccur)
        {
            ...
            if(0UL == u32RegDMAPeriph)
            {
                ...
                if(DMA_DMACHMAP1_R_CH8SEL_UART1_RX == u32RegDMASource)
                {
        ...
        if(0UL != u32RegDMAOccur)
        {
            ...
            if(0UL == u32RegDMAPeriph)
            {
                ...
                u32RegDMASource &= DMA_DMACHMAP2_R_CH22SEL_MASK;
                if(DMA_DMACHMAP2_R_CH22SEL_UART1_RX == u32RegDMASource)
                {
        ...
        if(0UL != u32RegDMAOccur)
        {
            ...
            if(0UL == u32RegDMAPeriph)
            {
                ...
                if(DMA_DMACHMAP1_R_CH9SEL_UART1_TX == u32RegDMASource)
                {
        ...
        if(0UL != u32RegDMAOccur)
        {
            ...
            {
                u32RegDMASource = DMA_DMACHMAP2_R;
                u32RegDMASource &= DMA_DMACHMAP2_R_CH23SEL_MASK;
                if(DMA_DMACHMAP2_R_CH23SEL_UART1_TX == u32RegDMASource)
                {
    ...
    {
        UART1_UARTICR_R = (uint32_t) UART_enINT_SOURCE_CLEAR_TO_SEND;
    ...
    {
        UART1_UARTICR_R = (uint32_t) UART_enINT_SOURCE_RECEIVE;
    ...
    {
        UART1_UARTICR_R = (uint32_t) UART_enINT_SOURCE_TRANSMIT;
    ...
    {
        UART1_UARTICR_R = (uint32_t) UART_enINT_SOURCE_RECEIVE_TIMEOUT;
