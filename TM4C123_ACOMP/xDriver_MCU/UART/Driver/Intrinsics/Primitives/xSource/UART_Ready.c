...
static SYSCTL_nPERIPHERAL SYSCTL_VECTOR_UART[(uint32_t) UART_enMODULE_MAX+1U] = {SYSCTL_enUART0, SYSCTL_enUART1, SYSCTL_enUART2, SYSCTL_enUART3, SYSCTL_enUART4, SYSCTL_enUART5, SYSCTL_enUART6, SYSCTL_enUART7};
