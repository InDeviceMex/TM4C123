...
SYSCTL_nSTATUS SYSCTL__enInit(void)
{
   ...
   (SYSCTL_RCC_R_XTAL_16MHZ |SYSCTL_RCC_R_OSCSRC_PIOSC |SYSCTL_RCC_R_BYPASS_MASK ),
   ...
   MCU__vWriteRegister(SYSCTL_BASE, SYSCTL_RCC_OFFSET, 0UL ,SYSCTL_RCC_R_OSCSRC_MASK ,0UL);
   ...
   (SYSCTL_RCC2_R_BYPASS2_MASK |SYSCTL_RCC2_R_DIV400_MASK    |SYSCTL_RCC2_R_USERCC2_MASK      | (2UL<<SYSCTL_RCC2_R_SYSDIV2_BIT) ),
   ...
   do{
    ...
    {
        MCU__vWriteRegister(SYSCTL_BASE, SYSCTL_RCC_OFFSET, 0UL, SYSCTL_RCC_R_BYPASS_MASK, 0UL);
        MCU__vWriteRegister(SYSCTL_BASE, SYSCTL_RCC2_OFFSET, 0UL, SYSCTL_RCC2_R_BYPASS2_MASK, 0UL);
    }
    return enStatus;
