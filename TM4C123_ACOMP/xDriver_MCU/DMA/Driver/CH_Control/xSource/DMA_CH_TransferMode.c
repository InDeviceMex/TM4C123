...
{
    DMA_CH__vSetPrimaryControlGeneric( enChannel, (uint32_t) enChannelTransferMode, DMACH_DMACHCTL_XFERMODE_MASK, DMACH_DMACHCTL_R_XFERMODE_BIT);
}

void DMA_CH__vSetAlternateTransferMode(DMA_nCH_MODULE enChannel, DMA_nCH_MODE enChannelTransferMode)
{
    DMA_CH__vSetAlternateControlGeneric( enChannel, (uint32_t) enChannelTransferMode, DMAALTCH_DMACHCTL_XFERMODE_MASK, DMAALTCH_DMACHCTL_R_XFERMODE_BIT);
}

void DMA_CH__vSetTransferMode(DMA_nCH_MODULE enChannel, DMA_nCH_CTL enChannelStructure, DMA_nCH_MODE enChannelTransferMode)
{
    DMA_CH__vSetControlGeneric( enChannel, enChannelStructure, (uint32_t) enChannelTransferMode, DMACH_DMACHCTL_XFERMODE_MASK, DMACH_DMACHCTL_R_XFERMODE_BIT);
}
...
DMA_nCH_MODE DMA_CH__enGetPrimaryTransferMode(DMA_nCH_MODULE enChannel)
{
    ...
    enReg = (DMA_nCH_MODE) DMA_CH__u32GetPrimaryControlGeneric( enChannel, DMACH_DMACHCTL_XFERMODE_MASK, DMACH_DMACHCTL_R_XFERMODE_BIT);
    return enReg;
}
...
{
    DMA_nCH_MODE enReg = DMA_enCH_MODE_UNDEF;
    enReg = (DMA_nCH_MODE) DMA_CH__u32GetControlGeneric( enChannel, enChannelStructure, DMACH_DMACHCTL_XFERMODE_MASK, DMACH_DMACHCTL_R_XFERMODE_BIT);
    return enReg;
}
