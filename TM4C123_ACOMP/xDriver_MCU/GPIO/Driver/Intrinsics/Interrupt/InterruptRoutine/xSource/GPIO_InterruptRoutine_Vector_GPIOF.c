...
void GPIOF__vIRQVectorHandler(void)
{
    ...
    {
        if(DMA_DMACHIS_R_CHIS15_OCCUR
                == (DMA_DMACHIS_R & DMA_DMACHIS_R_CHIS15_MASK))
        {
            if(DMA_DMAREQMASKSET_R_SET15_EN
                    == (DMA_DMAREQMASKSET_R & DMA_DMAREQMASKSET_R_SET15_MASK))
            {
                if(DMA_DMACHMAP1_R_CH15SEL_GPIOF
                        == (DMA_DMACHMAP1_R & DMA_DMACHMAP1_R_CH15SEL_MASK))
                {
