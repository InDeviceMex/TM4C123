...
void GPIOC__vIRQVectorHandler(void)
{
    ...
    {
        if(DMA_DMACHIS_R_CHIS6_OCCUR
                == (DMA_DMACHIS_R & DMA_DMACHIS_R_CHIS6_MASK))
        {
            if(DMA_DMAREQMASKSET_R_SET6_EN
                    == (DMA_DMAREQMASKSET_R & DMA_DMAREQMASKSET_R_SET6_MASK))
            {
                if(DMA_DMACHMAP0_R_CH6SEL_GPIOC
                        == (DMA_DMACHMAP0_R & DMA_DMACHMAP0_R_CH6SEL_MASK))
                {
