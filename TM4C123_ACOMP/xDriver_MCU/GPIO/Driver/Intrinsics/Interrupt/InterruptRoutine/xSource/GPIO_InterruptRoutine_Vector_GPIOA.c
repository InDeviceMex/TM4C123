...
void GPIOA__vIRQVectorHandler(void)
{
    ...
    {
        if(DMA_DMACHIS_R_CHIS4_OCCUR
                == (DMA_DMACHIS_R & DMA_DMACHIS_R_CHIS4_MASK))
        {
            if(DMA_DMAREQMASKSET_R_SET4_EN
                    == (DMA_DMAREQMASKSET_R & DMA_DMAREQMASKSET_R_SET4_MASK))
            {
                if(DMA_DMACHMAP0_R_CH4SEL_GPIOA
                        == (DMA_DMACHMAP0_R & DMA_DMACHMAP0_R_CH4SEL_MASK))
                {
