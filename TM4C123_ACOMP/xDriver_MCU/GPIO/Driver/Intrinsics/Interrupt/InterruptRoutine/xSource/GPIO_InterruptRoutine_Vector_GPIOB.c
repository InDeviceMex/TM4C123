...
void GPIOB__vIRQVectorHandler(void)
{
    ...
    {
        if(DMA_DMACHIS_R_CHIS5_OCCUR
                == (DMA_DMACHIS_R & DMA_DMACHIS_R_CHIS5_MASK))
        {
            if(DMA_DMAREQMASKSET_R_SET5_EN
                    == (DMA_DMAREQMASKSET_R & DMA_DMAREQMASKSET_R_SET5_MASK))
            {
        ...
        if(DMA_DMACHIS_R_CHIS18_OCCUR
                == (DMA_DMACHIS_R & DMA_DMACHIS_R_CHIS18_MASK))
        {
            if(DMA_DMAREQMASKSET_R_SET18_EN
                    == (DMA_DMAREQMASKSET_R & DMA_DMAREQMASKSET_R_SET18_MASK))
            {
