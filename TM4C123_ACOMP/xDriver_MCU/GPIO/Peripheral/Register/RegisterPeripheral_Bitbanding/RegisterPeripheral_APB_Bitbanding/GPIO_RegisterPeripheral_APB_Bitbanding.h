...
#define GPIO_APB_BITBANDING    ((GPIO_APB_BITBANDING_TypeDef*) (GPIO_BITBANDING_BASE + (GPIOA_APB_OFFSET * 32UL)))
#define GPIO_APB_AUX_BITBANDING    ((GPIO_APB_AUX_BITBANDING_TypeDef*)( GPIO_BITBANDING_BASE + (GPIOA_APB_OFFSET * 32UL)))

extern GPIO_BITBANDING_TypeDef *GPIO_APB_BITBANDING_BLOCK[(uint32_t) GPIO_enPORT_MAX];
extern GPIO_AUX_BITBANDING_TypeDef *GPIO_APB_AUX_BITBANDING_BLOCK[(uint32_t) GPIO_enPORT_MAX];
