...
typedef enum
{
    ...
    WDT_enMODE_RESET_STANDARD_CONTINUE_EN = ((uint32_t) WDT_enRESET_ENABLE << 24UL) | ((uint32_t) WDT_enINT_TYPE_STANDARD << 16UL) | ((uint32_t) WDT_enSTALL_CONTINUE << 8UL) | ((uint32_t) WDT_enINTERRUPT_ENABLE << 0UL),
    ...
    WDT_enMODE_RESET_STANDARD_FREEZE_EN = ((uint32_t) WDT_enRESET_ENABLE << 24UL) | ((uint32_t) WDT_enINT_TYPE_STANDARD << 16UL) | ((uint32_t) WDT_enSTALL_FREEZE << 8UL) | ((uint32_t) WDT_enINTERRUPT_ENABLE << 0UL),
    ...
    WDT_enMODE_RESET_NMI_CONTINUE_EN = ((uint32_t) WDT_enRESET_ENABLE << 24UL) | ((uint32_t) WDT_enINT_TYPE_NMI << 16UL) | ((uint32_t) WDT_enSTALL_CONTINUE << 8UL) | ((uint32_t) WDT_enINTERRUPT_ENABLE << 0UL),
    ...
    WDT_enMODE_RESET_NMI_FREEZE_EN = ((uint32_t) WDT_enRESET_ENABLE << 24UL) | ((uint32_t) WDT_enINT_TYPE_NMI << 16UL) | ((uint32_t) WDT_enSTALL_FREEZE << 8UL) | ((uint32_t) WDT_enINTERRUPT_ENABLE << 0UL),
    ...
    WDT_enMODE_NORESET_STANDARD_CONTINUE_EN = ((uint32_t) WDT_enRESET_DISABLE << 24UL) | ((uint32_t) WDT_enINT_TYPE_STANDARD << 16UL) | ((uint32_t) WDT_enSTALL_CONTINUE << 8UL) | ((uint32_t) WDT_enINTERRUPT_ENABLE << 0UL),
    ...
    WDT_enMODE_NORESET_STANDARD_FREEZE_EN = ((uint32_t) WDT_enRESET_DISABLE << 24UL) | ((uint32_t) WDT_enINT_TYPE_STANDARD << 16UL) | ((uint32_t) WDT_enSTALL_FREEZE << 8UL) | ((uint32_t) WDT_enINTERRUPT_ENABLE << 0UL),
    ...
    WDT_enMODE_NORESET_NMI_CONTINUE_EN = ((uint32_t) WDT_enRESET_DISABLE << 24UL) | ((uint32_t) WDT_enINT_TYPE_NMI << 16UL) | ((uint32_t) WDT_enSTALL_CONTINUE << 8UL) | ((uint32_t) WDT_enINTERRUPT_ENABLE << 0UL),
    ...
    WDT_enMODE_NORESET_NMI_FREEZE_EN = ((uint32_t) WDT_enRESET_DISABLE << 24UL) | ((uint32_t) WDT_enINT_TYPE_NMI << 16UL) | ((uint32_t) WDT_enSTALL_FREEZE << 8UL) | ((uint32_t) WDT_enINTERRUPT_ENABLE << 0UL),
