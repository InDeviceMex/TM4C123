...
{
    return (ADC_nSEQ_INPUT_ENDED) ADC__u32GetSampleGeneric((uint32_t) enModule, (uint32_t)  enSequencer, ADC_ADCSSCTL_OFFSET, (uint32_t) enMux, ADC_ADCSSCTL_END0_MASK, ADC_ADCSSCTL_R_END0_BIT);
}
