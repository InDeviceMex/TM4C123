...
extern void (*ADC_SAMPLE__vIRQSourceHandler[(uint32_t) ADC_enMODULE_MAX][(uint32_t) ADC_enSEQ_MAX]) (void);
extern void (*ADC_COMP__vIRQSourceHandler[(uint32_t) ADC_enMODULE_MAX][(uint32_t) ADC_enSEQ_MAX][(uint32_t) ADC_en_COMPARATOR_MAX]) (void);
