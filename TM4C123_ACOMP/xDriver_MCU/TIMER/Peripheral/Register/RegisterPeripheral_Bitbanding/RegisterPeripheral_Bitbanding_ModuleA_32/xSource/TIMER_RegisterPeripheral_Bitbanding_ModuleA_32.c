...
GPWTM_BITBANDING_TA_TypeDef* GPWTM_BITBANDING_TA_BLOCK[(uint32_t) TIMER_enMODULE_NUM_MAX] = { GPWTM0_BITBANDING_TA, GPWTM1_BITBANDING_TA, GPWTM2_BITBANDING_TA, GPWTM3_BITBANDING_TA, GPWTM4_BITBANDING_TA, GPWTM5_BITBANDING_TA};
