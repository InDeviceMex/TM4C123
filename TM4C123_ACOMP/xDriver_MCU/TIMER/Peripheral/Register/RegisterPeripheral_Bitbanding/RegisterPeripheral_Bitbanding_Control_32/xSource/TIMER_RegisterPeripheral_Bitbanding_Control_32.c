...
GPTM_BITBANDING_CTL_TypeDef* GPTM_BITBANDING_CTL_BLOCK[(uint32_t) TIMER_enMODULE_NUM_MAX] = { GPTM0_BITBANDING_CTL, GPTM1_BITBANDING_CTL, GPTM2_BITBANDING_CTL, GPTM3_BITBANDING_CTL, GPTM4_BITBANDING_CTL, GPTM5_BITBANDING_CTL};
