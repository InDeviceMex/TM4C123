...
GPWTM_BITBANDING_TW_TypeDef* GPWTM_BITBANDING_TW_BLOCK[(uint32_t) TIMER_enMODULE_NUM_MAX] = {GPWTM0_BITBANDING_TW, GPWTM1_BITBANDING_TW, GPWTM2_BITBANDING_TW, GPWTM3_BITBANDING_TW, GPWTM4_BITBANDING_TW, GPWTM5_BITBANDING_TW};
