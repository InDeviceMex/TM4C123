...
GPTM_BITBANDING_TB_TypeDef* GPTM_BITBANDING_TB_BLOCK[(uint32_t) TIMER_enMODULE_NUM_MAX] = { GPTM0_BITBANDING_TB, GPTM1_BITBANDING_TB, GPTM2_BITBANDING_TB, GPTM3_BITBANDING_TB, GPTM4_BITBANDING_TB, GPTM5_BITBANDING_TB};
