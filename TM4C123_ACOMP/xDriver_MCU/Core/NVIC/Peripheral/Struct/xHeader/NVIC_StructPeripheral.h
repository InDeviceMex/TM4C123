...
{
    volatile uint32_t ISER[5UL];                 /*!< Offset: 0x000 (R/W)  Interrupt Set Enable Register           */
    const uint32_t reserved0[27UL];
    volatile uint32_t ICER[5UL];                 /*!< Offset: 0x080 (R/W)  Interrupt Clear Enable Register         */
    const uint32_t reserved1[27UL];
    volatile uint32_t ISPR[5UL];                 /*!< Offset: 0x100 (R/W)  Interrupt Set Pending Register          */
    const uint32_t reserved2[27UL];
    volatile uint32_t ICPR[5UL];                 /*!< Offset: 0x180 (R/W)  Interrupt Clear Pending Register        */
    const uint32_t reserved3[27UL];
    volatile uint32_t IABR[5UL];                 /*!< Offset: 0x200 (R/W)  Interrupt Active bit Register           */
    const uint32_t reserved4[59UL];
