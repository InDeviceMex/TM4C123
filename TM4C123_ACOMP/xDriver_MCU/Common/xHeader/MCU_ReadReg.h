...
#pragma  CODE_SECTION(MCU__u32ReadRegister, ".ramcode")
...
uint32_t MCU__u32ReadRegister(uint32_t u32PeripheralBase, uint32_t u32OffsetRegister, uint32_t u32MaskFeature, uint32_t u32BitFeature) __attribute__((section(".ramcode")));
