...
#define SYSEXC_SYSEXCRIS_OFFSET    ((uint32_t) 0x0000UL)
#define SYSEXC_SYSEXCIM_OFFSET    ((uint32_t) 0x0004UL)
#define SYSEXC_SYSEXCMIS_OFFSET    ((uint32_t) 0x0008UL)
#define SYSEXC_SYSEXCIC_OFFSET    ((uint32_t) 0x000CUL)
