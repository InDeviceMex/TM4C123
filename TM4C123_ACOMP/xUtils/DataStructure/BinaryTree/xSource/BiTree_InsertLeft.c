...
BiTreeElement_TypeDef* BiTree__psInsertLeft(BiTree_TypeDef* psTree, BiTreeElement_TypeDef* psElement, void* pvData)
{
     ...
     BiTreeElement_TypeDef* psElementLeft = (BiTreeElement_TypeDef*) 0UL ;
     ...
     if(((uint32_t)0UL != (uint32_t)psTree))
     {
         ...
         {
             psElementLeft = BiTree__psGetElementLeftNode(psElement);
             if((uint32_t)0UL == (uint32_t)psElementLeft)
             {
        ...
        if((uint32_t)0UL != (uint32_t)psNewElement)
        {
            ...
            BiTree__vSetElementLeftNode(psNewElement, (BiTreeElement_TypeDef*) 0UL);
