 ...
 */
#ifndef XUTILS_DATASTRUCTURE_BINARYTREE_XHEADER_BITREE_REMOVELEFT_H_
#define XUTILS_DATASTRUCTURE_BINARYTREE_XHEADER_BITREE_REMOVELEFT_H_
...
#endif /* XUTILS_DATASTRUCTURE_BINARYTREE_XHEADER_BITREE_REMOVELEFT_H_ */
