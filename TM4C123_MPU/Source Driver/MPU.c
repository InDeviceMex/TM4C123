...
void MPU__vInit(void)
{
	...
	u32RegRASR =MPU_RASR_R_XN_EN|MPU_RASR_R_AP_RORO|MPU_RASR_R_S_DIS|MPU_RASR_R_C_DIS|
    ...
    u32RegRASR =MPU_RASR_R_XN_EN|MPU_RASR_R_AP_RORO|MPU_RASR_R_S_DIS|MPU_RASR_R_C_DIS|
            MPU_RASR_R_B_DIS|MPU_RASR_R_TEX_WB_WRA|MPU_RASR_R_ENABLE_EN|(MPU_FLASH_CODE_SIZE<<1);
    MPU_RASR_R = u32RegRASR;
