...
{
    /*GPIOA*/
    GPIO_enGPIOA0   =(0<<16)|((0*4u)<<8)|(0u),
    GPIO_enU0Rx     =(0<<16)|((0*4u)<<8)|(1u),
    GPIO_enCAN1Rx   =(0<<16)|((0*4u)<<8)|(8u),

    GPIO_enGPIOA1   =(0<<16)|((1*4u)<<8)|(0u),
    GPIO_enU0Tx     =(0<<16)|((1*4u)<<8)|(1u),
    GPIO_enCAN1Tx   =(0<<16)|((1*4u)<<8)|(8u),

    GPIO_enGPIOA2   =(0<<16)|((2*4u)<<8)|(0u),
    GPIO_enSSI0Clk  =(0<<16)|((2*4u)<<8)|(2u),

    GPIO_enGPIOA3   =(0<<16)|((3*4u)<<8)|(0u),
    GPIO_enSSI0Fss  =(0<<16)|((3*4u)<<8)|(2u),

    GPIO_enGPIOA4   =(0<<16)|((4*4u)<<8)|(0u),
    GPIO_enSSI0Rx   =(0<<16)|((4*4u)<<8)|(2u),

    GPIO_enGPIOA5   =(0<<16)|((5*4u)<<8)|(0u),
    GPIO_enSSI0Tx   =(0<<16)|((5*4u)<<8)|(2u),

    GPIO_enGPIOA6   =(0<<16)|((6*4u)<<8)|(0u),
    GPIO_enI2C1SCL  =(0<<16)|((6*4u)<<8)|(3u),
    GPIO_enM1PWM2   =(0<<16)|((6*4u)<<8)|(5u),

    GPIO_enGPIOA7   =(0<<16)|((7*4u)<<8)|(0u),
    GPIO_enI2C1SDA  =(0<<16)|((7*4u)<<8)|(3u),
    GPIO_enM1PWM3   =(0<<16)|((7*4u)<<8)|(5u),

    /*GPIOB*/
    GPIO_enGPIOB0   =(1<<16)|((0*4u)<<8)|(0u),
    GPIO_enU1Rx     =(1<<16)|((0*4u)<<8)|(1u),
    GPIO_enT2CCP0   =(1<<16)|((0*4u)<<8)|(7u),

    GPIO_enGPIOB1   =(1<<16)|((1*4u)<<8)|(0u),
    GPIO_enU1Tx     =(1<<16)|((1*4u)<<8)|(1u),
    GPIO_enT2CCP1   =(1<<16)|((1*4u)<<8)|(7u),

    GPIO_enGPIOB2   =(1<<16)|((2*4u)<<8)|(0u),
    GPIO_enI2C0SCL  =(1<<16)|((2*4u)<<8)|(3u),
    GPIO_enT3CCP0   =(1<<16)|((2*4u)<<8)|(7u),

    GPIO_enGPIOB3   =(1<<16)|((3*4u)<<8)|(0u),
    GPIO_enI2C0SDA  =(1<<16)|((3*4u)<<8)|(3u),
    GPIO_enT3CCP1   =(1<<16)|((3*4u)<<8)|(7u),

    GPIO_enGPIOB4   =(1<<16)|((4*4u)<<8)|(0u),
    GPIO_enSSI2Clk  =(1<<16)|((4*4u)<<8)|(2u),
    GPIO_enM0PWM2   =(1<<16)|((4*4u)<<8)|(4u),
    GPIO_enT1CCP0   =(1<<16)|((4*4u)<<8)|(7u),
    GPIO_enCAN0Rx   =(1<<16)|((4*4u)<<8)|(8u),

    GPIO_enGPIOB5   =(1<<16)|((5*4u)<<8)|(0u),
    GPIO_enSSI2Fss  =(1<<16)|((5*4u)<<8)|(2u),
    GPIO_enM0PWM3   =(1<<16)|((5*4u)<<8)|(4u),
    GPIO_enT1CCP1   =(1<<16)|((5*4u)<<8)|(7u),
    GPIO_enCAN0Tx   =(1<<16)|((5*4u)<<8)|(8u),

    GPIO_enGPIOB6   =(1<<16)|((6*4u)<<8)|(0u),
    GPIO_enSSI2Rx   =(1<<16)|((6*4u)<<8)|(2u),
    GPIO_enM0PWM0   =(1<<16)|((6*4u)<<8)|(4u),
    GPIO_enT0CCP0   =(1<<16)|((6*4u)<<8)|(7u),

    GPIO_enGPIOB7   =(1<<16)|((7*4u)<<8)|(0u),
    GPIO_enSSI2Tx   =(1<<16)|((7*4u)<<8)|(2u),
    GPIO_enM0PWM1   =(1<<16)|((7*4u)<<8)|(4u),
    GPIO_enT0CCP1   =(1<<16)|((7*4u)<<8)|(7u),

    /*GPIOC*/
    GPIO_enGPIOC0    =(2<<16)|((0*4u)<<8)|(0u),
    GPIO_enTCK       =(2<<16)|((0*4u)<<8)|(1u),
    GPIO_enT4CCP0    =(2<<16)|((0*4u)<<8)|(7u),

    GPIO_enGPIOC1    =(2<<16)|((1*4u)<<8)|(0u),
    GPIO_enTMS       =(2<<16)|((1*4u)<<8)|(1u),
    GPIO_enT4CCP1    =(2<<16)|((1*4u)<<8)|(7u),

    GPIO_enGPIOC2    =(2<<16)|((2*4u)<<8)|(0u),
    GPIO_enTDI       =(2<<16)|((2*4u)<<8)|(1u),
    GPIO_enT5CCP0    =(2<<16)|((2*4u)<<8)|(7u),

    GPIO_enGPIOC3    =(2<<16)|((3*4u)<<8)|(0u),
    GPIO_enTDO       =(2<<16)|((3*4u)<<8)|(1u),
    GPIO_enT5CCP1    =(2<<16)|((3*4u)<<8)|(7u),

    GPIO_enGPIOC4    =(2<<16)|((4*4u)<<8)|(0u),
    GPIO_enU4Rx      =(2<<16)|((4*4u)<<8)|(1u),
    GPIO_enU1Rx_C4   =(2<<16)|((4*4u)<<8)|(2u),
    GPIO_enM0PWM6    =(2<<16)|((4*4u)<<8)|(4u),
    GPIO_enIDX1      =(2<<16)|((4*4u)<<8)|(6u),
    GPIO_enWT0CCP0   =(2<<16)|((4*4u)<<8)|(7u),
    GPIO_enU1RTS     =(2<<16)|((4*4u)<<8)|(8u),

    GPIO_enGPIOC5    =(2<<16)|((5*4u)<<8)|(0u),
    GPIO_enU4Tx      =(2<<16)|((5*4u)<<8)|(1u),
    GPIO_enU1Tx_C4   =(2<<16)|((5*4u)<<8)|(2u),
    GPIO_enM0PWM7    =(2<<16)|((5*4u)<<8)|(4u),
    GPIO_enPhA1      =(2<<16)|((5*4u)<<8)|(6u),
    GPIO_enWT0CCP1   =(2<<16)|((5*4u)<<8)|(7u),
    GPIO_enU1CTS     =(2<<16)|((5*4u)<<8)|(8u),

    GPIO_enGPIOC6    =(2<<16)|((6*4u)<<8)|(0u),
    GPIO_enU3Rx      =(2<<16)|((6*4u)<<8)|(1u),
    GPIO_enPhB1      =(2<<16)|((6*4u)<<8)|(6u),
    GPIO_enWT1CCP0   =(2<<16)|((6*4u)<<8)|(7u),
    GPIO_enUSB0EPEN  =(2<<16)|((6*4u)<<8)|(8u),

    GPIO_enGPIOC7    =(2<<16)|((7*4u)<<8)|(0u),
    GPIO_enU3Tx      =(2<<16)|((7*4u)<<8)|(1u),
    GPIO_enWT1CCP1   =(2<<16)|((7*4u)<<8)|(7u),
    GPIO_enUSB0PFLT  =(2<<16)|((7*4u)<<8)|(8u),

    /*GPIOD*/
    GPIO_enGPIOD0    =(3<<16)|((0*4u)<<8)|(0u),
    GPIO_enSSI3Clk   =(3<<16)|((0*4u)<<8)|(1u),
    GPIO_enSSI1Clk   =(3<<16)|((0*4u)<<8)|(2u),
    GPIO_enI2C3SCL   =(3<<16)|((0*4u)<<8)|(3u),
    GPIO_enM0PWM6_D0 =(3<<16)|((0*4u)<<8)|(4u),
    GPIO_enM1PWM0    =(3<<16)|((0*4u)<<8)|(5u),
    GPIO_enWT2CCP0   =(3<<16)|((0*4u)<<8)|(7u),

    GPIO_enGPIOD1    =(3<<16)|((1*4u)<<8)|(0u),
    GPIO_enSSI3Fss   =(3<<16)|((1*4u)<<8)|(1u),
    GPIO_enSSI1Fss   =(3<<16)|((1*4u)<<8)|(2u),
    GPIO_enI2C3SDA   =(3<<16)|((1*4u)<<8)|(3u),
    GPIO_enM0PWM7_D1 =(3<<16)|((1*4u)<<8)|(4u),
    GPIO_enM1PWM1    =(3<<16)|((1*4u)<<8)|(5u),
    GPIO_enWT2CCP1   =(3<<16)|((1*4u)<<8)|(7u),

    GPIO_enGPIOD2    =(3<<16)|((2*4u)<<8)|(0u),
    GPIO_enSSI3Rx    =(3<<16)|((2*4u)<<8)|(1u),
    GPIO_enSSI1Rx    =(3<<16)|((2*4u)<<8)|(2u),
    GPIO_enM0FAULT0  =(3<<16)|((2*4u)<<8)|(4u),
    GPIO_enWT3CCP0   =(3<<16)|((2*4u)<<8)|(7u),
    GPIO_enUSB0EPEN_D2=(3<<16)|((2*4u)<<8)|(8u),

    GPIO_enGPIOD3    =(3<<16)|((3*4u)<<8)|(0u),
    GPIO_enSSI3Tx    =(3<<16)|((3*4u)<<8)|(1u),
    GPIO_enSSI1Tx    =(3<<16)|((3*4u)<<8)|(2u),
    GPIO_enIDX0      =(3<<16)|((3*4u)<<8)|(6u),
    GPIO_enWT3CCP1   =(3<<16)|((3*4u)<<8)|(7u),
    GPIO_enUSB0PFLT_D3=(3<<16)|((3*4u)<<8)|(8u),

    GPIO_enGPIOD4    =(3<<16)|((4*4u)<<8)|(0u),
    GPIO_enU6Rx      =(3<<16)|((4*4u)<<8)|(1u),
    GPIO_enWT4CCP0   =(3<<16)|((4*4u)<<8)|(7u),

    GPIO_enGPIOD5    =(3<<16)|((5*4u)<<8)|(0u),
    GPIO_enU6Tx      =(3<<16)|((5*4u)<<8)|(1u),
    GPIO_enWT4CCP1   =(3<<16)|((5*4u)<<8)|(7u),

    GPIO_enGPIOD6    =(3<<16)|((6*4u)<<8)|(0u),
    GPIO_enU2Rx      =(3<<16)|((6*4u)<<8)|(1u),
    GPIO_enM0FAULT0_D6=(3<<16)|((6*4u)<<8)|(4u),
    GPIO_enPhA0      =(3<<16)|((6*4u)<<8)|(6u),
    GPIO_enWT5CCP0   =(3<<16)|((6*4u)<<8)|(7u),

    GPIO_enGPIOD7    =(3<<16)|((7*4u)<<8)|(0u),
    GPIO_enU2Tx      =(3<<16)|((7*4u)<<8)|(1u),
    GPIO_enPhB0      =(3<<16)|((7*4u)<<8)|(6u),
    GPIO_enWT5CCP1   =(3<<16)|((7*4u)<<8)|(7u),
    GPIO_enNMI       =(3<<16)|((7*4u)<<8)|(8u),

    /*GPIOE*/
    GPIO_enGPIOE0    =(4<<16)|((0*4u)<<8)|(0u),
    GPIO_enU7Rx      =(4<<16)|((0*4u)<<8)|(1u),

    GPIO_enGPIOE1    =(4<<16)|((1*4u)<<8)|(0u),
    GPIO_enU7Tx      =(4<<16)|((1*4u)<<8)|(1u),

    GPIO_enGPIOE2    =(4<<16)|((2*4u)<<8)|(0u),
    GPIO_enGPIOE3    =(4<<16)|((3*4u)<<8)|(0u),

    GPIO_enGPIOE4    =(4<<16)|((4*4u)<<8)|(0u),
    GPIO_enU5Rx      =(4<<16)|((4*4u)<<8)|(1u),
    GPIO_enI2C2SCL   =(4<<16)|((4*4u)<<8)|(3u),
    GPIO_enM0PWM4    =(4<<16)|((4*4u)<<8)|(4u),
    GPIO_enM1PWM2_E4 =(4<<16)|((4*4u)<<8)|(5u),
    GPIO_enCAN0Rx_E4 =(4<<16)|((4*4u)<<8)|(8u),

    GPIO_enGPIOE5    =(4<<16)|((5*4u)<<8)|(0u),
    GPIO_enU5Tx      =(4<<16)|((5*4u)<<8)|(1u),
    GPIO_enI2C2SDA   =(4<<16)|((5*4u)<<8)|(3u),
    GPIO_enM0PWM5    =(4<<16)|((5*4u)<<8)|(4u),
    GPIO_enM1PWM3_E5 =(4<<16)|((5*4u)<<8)|(5u),
    GPIO_enCAN0Tx_E5 =(4<<16)|((5*4u)<<8)|(8u),

    GPIO_enGPIOE6    =(4<<16)|((6*4u)<<8)|(0u),
    GPIO_enGPIOE7    =(4<<16)|((7*4u)<<8)|(0u),

    /*GPIOF*/
    GPIO_enGPIOF0    =(5<<16)|((0*4u)<<8)|(0u),
    GPIO_enU1RTS_F0  =(5<<16)|((0*4u)<<8)|(1u),
    GPIO_enSSI1Rx_F0 =(5<<16)|((0*4u)<<8)|(2u),
    GPIO_enCAN0Rx_F0 =(5<<16)|((0*4u)<<8)|(3u),
    GPIO_enM1PWM4    =(5<<16)|((0*4u)<<8)|(5u),
    GPIO_enPhA0_F0   =(5<<16)|((0*4u)<<8)|(6u),
    GPIO_enT0CCP0_F0 =(5<<16)|((0*4u)<<8)|(7u),
    GPIO_enNMI_F0    =(5<<16)|((0*4u)<<8)|(8u),
    GPIO_enC0o       =(5<<16)|((0*4u)<<8)|(9u),

    GPIO_enGPIOF1    =(5<<16)|((1*4u)<<8)|(0u),
    GPIO_enU1CTS_F1  =(5<<16)|((1*4u)<<8)|(1u),
    GPIO_enSSI1Tx_F1 =(5<<16)|((1*4u)<<8)|(2u),
    GPIO_enM1PWM5    =(5<<16)|((1*4u)<<8)|(5u),
    GPIO_enPhB0_F1   =(5<<16)|((1*4u)<<8)|(6u),
    GPIO_enT0CCP1_F1 =(5<<16)|((1*4u)<<8)|(7u),
    GPIO_enC1o       =(5<<16)|((1*4u)<<8)|(9u),
    GPIO_enTRD1      =(5<<16)|((1*4u)<<8)|(14u),

    GPIO_enGPIOF2    =(5<<16)|((2*4u)<<8)|(0u),
    GPIO_enSSI1Clk_F2=(5<<16)|((2*4u)<<8)|(2u),
    GPIO_enM0FAULT0_F2=(5<<16)|((2*4u)<<8)|(4u),
    GPIO_enM1PWM6    =(5<<16)|((2*4u)<<8)|(5u),
    GPIO_enT1CCP0_F2 =(5<<16)|((2*4u)<<8)|(7u),
    GPIO_enTRD0      =(5<<16)|((2*4u)<<8)|(14u),

    GPIO_enGPIOF3    =(5<<16)|((3*4u)<<8)|(0u),
    GPIO_enSSI1Fss_F3=(5<<16)|((3*4u)<<8)|(2u),
    GPIO_enCAN0Tx_F3 =(5<<16)|((3*4u)<<8)|(3u),
    GPIO_enM1PWM7    =(5<<16)|((3*4u)<<8)|(5u),
    GPIO_enT1CCP1_F3 =(5<<16)|((3*4u)<<8)|(7u),
    GPIO_enTRCLK     =(5<<16)|((3*4u)<<8)|(14u),

    GPIO_enGPIOF4    =(5<<16)|((4*4u)<<8)|(0u),
    GPIO_enM1FAULT0  =(5<<16)|((4*4u)<<8)|(5u),
    GPIO_enIDX0_F4   =(5<<16)|((4*4u)<<8)|(6u),
    GPIO_enT2CCP0_F4 =(5<<16)|((4*4u)<<8)|(7u),
    GPIO_enUSB0EPEN_F4=(5<<16)|((4*4u)<<8)|(8u),

    GPIO_enGPIOF5    =(5<<16)|((5*4u)<<8)|(0u),
    GPIO_enGPIOF6    =(5<<16)|((6*4u)<<8)|(0u),
    GPIO_enGPIOF7    =(5<<16)|((7*4u)<<8)|(0u),
}GPIO_nDIGITAL_FUNCTION;

/*PORT PIN*/
typedef enum
{
    GPIO_enUSB0ID=(1<<8)|(0u),
    GPIO_enUSB0VBUS=(1<<8)|(1u),
    GPIO_enAIN10=(1<<8)|(4u),
    GPIO_enAIN11=(1<<8)|(5u),
    ...
    GPIO_enAIN5=(3<<8)|(2u),
    GPIO_enAIN4=(3<<8)|(3u),
    GPIO_enUSB0DM=(3<<8)|(4u),
    GPIO_enUSB0DP=(3<<8)|(5u),
