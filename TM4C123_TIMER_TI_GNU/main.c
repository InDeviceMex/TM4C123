...
int main(void)
{
    ...
    GPTM_UNION->CONTROL[0].GPTMCFG=4;

    GPTM_UNION->TIMERB[0].GPTMTnMR_Bit.TnAMS=1;
    GPTM_UNION->TIMERB[0].GPTMTnMR_Bit.TnCMR=0;
    GPTM_UNION->TIMERB[0].GPTMTnMR_Bit.TnMR=2;
    GPTM_UNION->TIMERB[0].GPTMTnCTL_Bit.TnPWML=0;
    GPTM_UNION->TIMERB[0].GPTMTnPR=(((32*32*32)-1)>>16)&0xFF;

    GPTM_UNION->TIMERB[0].GPTMTnCTL_Bit.TnEVENT=0;
    GPTM_UNION->TIMERB[0].GPTMTnMR_Bit.TnPWMIE=1;
    GPTM_UNION->TIMERB[0].GPTMTnILR=((32*32*32)-1)&0xFFFF;
    GPTM_UNION->TIMERB[0].GPTMTnPMR=(((32*32*32)-2)>>16)&0xFF;
    GPTM_UNION->TIMERB[0].GPTMTnMATCHR=((32*32*32)-2)&0xFFFF;

    GPTM_UNION->TIMERB[0].GPTMTnMR_Bit.TnILD=1;
    GPTM_UNION->TIMERB[0].GPTMTnMR_Bit.TnMRSU=1;
    GPTM_UNION->TIMERB[0].GPTMTnCTL_Bit.TnSTALL=1;



    GPTM_UNION->CONTROL[1].GPTMCFG=4;

    GPTM_UNION->TIMERA[1].GPTMTnMR_Bit.TnAMS=1;
    GPTM_UNION->TIMERA[1].GPTMTnMR_Bit.TnCMR=0;
    GPTM_UNION->TIMERA[1].GPTMTnMR_Bit.TnMR=2;
    GPTM_UNION->TIMERA[1].GPTMTnCTL_Bit.TnPWML=0;
    GPTM_UNION->TIMERA[1].GPTMTnPR=(((32*32)-1)>>16)&0xFF;

    GPTM_UNION->TIMERA[1].GPTMTnCTL_Bit.TnEVENT=0;
    GPTM_UNION->TIMERA[1].GPTMTnMR_Bit.TnPWMIE=1;
    GPTM_UNION->TIMERA[1].GPTMTnILR=((32*32)-1)&0xFFFF;
    GPTM_UNION->TIMERA[1].GPTMTnPMR=(((32*32)-2)>>16)&0xFF;
    GPTM_UNION->TIMERA[1].GPTMTnMATCHR=((32*32)-2)&0xFFFF;

    GPTM_UNION->TIMERA[1].GPTMTnMR_Bit.TnILD=1;
    GPTM_UNION->TIMERA[1].GPTMTnMR_Bit.TnMRSU=1;
    GPTM_UNION->TIMERA[1].GPTMTnCTL_Bit.TnSTALL=1;

    GPTM_UNION->TIMERB[1].GPTMTnMR_Bit.TnAMS=1;
    GPTM_UNION->TIMERB[1].GPTMTnMR_Bit.TnCMR=0;
    GPTM_UNION->TIMERB[1].GPTMTnMR_Bit.TnMR=2;
    GPTM_UNION->TIMERB[1].GPTMTnCTL_Bit.TnPWML=0;
    GPTM_UNION->TIMERB[1].GPTMTnPR=((32-1)>>16)&0xFF;

    GPTM_UNION->TIMERB[1].GPTMTnCTL_Bit.TnEVENT=0;
    GPTM_UNION->TIMERB[1].GPTMTnMR_Bit.TnPWMIE=1;
    GPTM_UNION->TIMERB[1].GPTMTnILR=((32)-1)&0xFFFF;
    GPTM_UNION->TIMERB[1].GPTMTnPMR=((32-2)>>16)&0xFF;
    GPTM_UNION->TIMERB[1].GPTMTnMATCHR=((32)-2)&0xFFFF;

    GPTM_UNION->TIMERB[1].GPTMTnMR_Bit.TnILD=1;
    GPTM_UNION->TIMERB[1].GPTMTnMR_Bit.TnMRSU=1;
    GPTM_UNION->TIMERB[1].GPTMTnCTL_Bit.TnSTALL=1;


    GPTM_UNION->TIMERB[0].GPTMTnIMR_Bit.CnEIM=1;
    GPTM_UNION->TIMERA[1].GPTMTnIMR_Bit.CnEIM=1;
    GPTM_UNION->TIMERB[1].GPTMTnIMR_Bit.CnEIM=1;


    GPTM_UNION->TIMERB[0].GPTMTnCTL_Bit.TnEN=1;
    GPTM_UNION->TIMERA[1].GPTMTnCTL_Bit.TnEN=1;
    GPTM_UNION->TIMERB[1].GPTMTnCTL_Bit.TnEN=1;


    //GPTM_UNION->CONTROL[0].GPTMSYNC=(3<<2) |0x2;

/*
    GPTM_UNION->TIMERA[0].GPTMTAMR_Bit.TAMR=2;
    GPTM_UNION->TIMERA[0].GPTMTAMR_Bit.TACDIR=0;
    GPTM_UNION->TIMERA[0].GPTMACTL_Bit.TASTALL=1;
    if(GPTM_UNION->TIMERA[0].GPTMTAMR_Bit.TACDIR ==1)
    {
        GPTM_UNION->TIMERA[0].GPTMTAPR=((0x80000-1)>>16)&0xFF;
        GPTM_UNION->TIMERA[0].GPTMTAILR=((0x80000)-1)&0xFFFF;
    }
    else
    {
        GPTM_UNION->TIMERA[0].GPTMTAPR=((0x80000-1))&0xFF;
        GPTM_UNION->TIMERA[0].GPTMTAILR=((0x80000-1)>>8)&0xFFFF;
    }

    GPTM_UNION->CONTROL[1].GPTMCFG=0;

    GPTM_UNION->TIMERW[1].GPTMTWMR_Bit.TWMR=2;
    GPTM_UNION->TIMERW[1].GPTMTWMR_Bit.TWCDIR=0;
    GPTM_UNION->TIMERW[1].GPTMWCTL_Bit.TWSTALL=1;
    GPTM_UNION->TIMERW[1].GPTMTWILR=((0x100000)-1);

    GPTM_UNION->TIMERA[0].GPTMAICR_Bit.TATOCINT=1;
    GPTM_UNION->TIMERB[0].GPTMBICR_Bit.TBTOCINT=1;
    GPTM_UNION->TIMERW[1].GPTMWICR_Bit.TWTOCINT=1;
    GPTM_UNION->TIMERA[0].GPTMAIMR_Bit.TATOIM=1;
    GPTM_UNION->TIMERB[0].GPTMBIMR_Bit.CBEIM=1;
    GPTM_UNION->TIMERW[1].GPTMWIMR_Bit.TWTOIM=1;


    GPTM_UNION->TIMERW[1].GPTMWCTL_Bit.TWEN=1;
    GPTM_UNION->TIMERA[0].GPTMACTL_Bit.TAEN=1;
    GPTM_UNION->TIMERB[0].GPTMBCTL_Bit.TBEN=1;


    GPTM_UNION->CONTROL[0].GPTMSYNC=(1<<2) |0x3;
*/
    while(1)
    {
...
void TIMER0B_vISR(void)
{
    ...
    GPTM_UNION->TIMERB[0].GPTMTnICR_Bit.CnECINT=1;
    if(u32Value==0)
        u32Value=32*32*32;
    u32Value-=32*32;
    GPTM_UNION->TIMERB[0].GPTMTnPMR=((u32Value)>>16)&0xFF;
    GPTM_UNION->TIMERB[0].GPTMTnMATCHR=((u32Value))&0xFFFF;
...
void TIMER1A_vISR(void)
{
    ...
    GPTM_UNION->TIMERA[1].GPTMTnICR_Bit.CnECINT=1;
    if(u32Value==0)
        u32Value=32*32;
    u32Value-=32;
    GPTM_UNION->TIMERA[1].GPTMTnPMR=((u32Value)>>16)&0xFF;
    GPTM_UNION->TIMERA[1].GPTMTnMATCHR=((u32Value))&0xFFFF;
...
void TIMER1B_vISR(void)
{
    ...
    GPTM_UNION->TIMERB[1].GPTMTnICR_Bit.CnECINT=1;
    if(u32Value==0)
        u32Value=32;
    u32Value--;
    GPTM_UNION->TIMERB[1].GPTMTnPMR=((u32Value)>>16)&0xFF;
    GPTM_UNION->TIMERB[1].GPTMTnMATCHR=((u32Value))&0xFFFF;
}
void MAIN_vInitGPIO(void)
{
    GPIO__vInit();
