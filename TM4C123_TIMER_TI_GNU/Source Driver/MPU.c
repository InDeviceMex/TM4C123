...
void MPU__vInit(void)
{
	...
	/*enable region*/
    MPU_RNR_R=0;
	MPU_RBAR_R=0x00000000|MPU_RBAR_R_VALID_MASK|0;/*FLASH_CONSTANT (size 0x00040000u)*/
    ...
    /*enable region*/
    MPU_RNR_R=1;
    MPU_RBAR_R=0x00000000|MPU_RBAR_R_VALID_MASK|1;/*FLASH_CODE (size 0x00010000u)*/
