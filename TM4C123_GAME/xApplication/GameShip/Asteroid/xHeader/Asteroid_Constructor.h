 ...
 */
#ifndef XAPPLICATION_GAMESHIP_ASTEROID_XHEADER_ASTEROID_CONSTRUCTOR_H_
#define XAPPLICATION_GAMESHIP_ASTEROID_XHEADER_ASTEROID_CONSTRUCTOR_H_
...
#endif /* XAPPLICATION_GAMESHIP_ASTEROID_XHEADER_ASTEROID_CONSTRUCTOR_H_ */
