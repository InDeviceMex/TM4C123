...
#ifndef XAPPLICATION_GAMESHIP_SHIP_XHEADER_SHIP_DRAW_H_
#define XAPPLICATION_GAMESHIP_SHIP_XHEADER_SHIP_DRAW_H_
...
#endif /* XAPPLICATION_GAMESHIP_SHIP_XHEADER_SHIP_DRAW_H_ */
