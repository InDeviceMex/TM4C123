...
#ifndef XAPPLICATION_GAMESHIP_SHIP_XHEADER_SHIP_DESTROY_H_
#define XAPPLICATION_GAMESHIP_SHIP_XHEADER_SHIP_DESTROY_H_

#include <xApplication/GameShip/Ship/xHeader/Ship_Struct.h>

uint32_t Ship__u32Destroy(Ship_TypeDef* psShipArg);

#endif /* XAPPLICATION_GAMESHIP_SHIP_XHEADER_SHIP_DESTROY_H_ */
