...
#define DMACH_DMASRCENDP_OFFSET    ((uint32_t) 0x00000000UL)
#define DMACH_DMADSTENDP_OFFSET    ((uint32_t) 0x00000004UL)
#define DMACH_DMACHCTL_OFFSET    ((uint32_t) 0x00000008UL)
#define DMACH_RESERVED_OFFSET    ((uint32_t) 0x0000000CUL)

#define DMAALTCH_DMASRCENDP_OFFSET    ((uint32_t) 0x00000000UL)
#define DMAALTCH_DMADSTENDP_OFFSET    ((uint32_t) 0x00000004UL)
#define DMAALTCH_DMACHCTL_OFFSET    ((uint32_t) 0x00000008UL)
