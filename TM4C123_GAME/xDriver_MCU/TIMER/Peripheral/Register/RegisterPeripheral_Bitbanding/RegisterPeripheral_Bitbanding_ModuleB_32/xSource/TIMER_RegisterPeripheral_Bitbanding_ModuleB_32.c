...
GPWTM_BITBANDING_TB_TypeDef* GPWTM_BITBANDING_TB_BLOCK[(uint32_t) TIMER_enMODULE_NUM_MAX] = { GPWTM0_BITBANDING_TB, GPWTM1_BITBANDING_TB, GPWTM2_BITBANDING_TB, GPWTM3_BITBANDING_TB, GPWTM4_BITBANDING_TB, GPWTM5_BITBANDING_TB};
