...
#define NVIC_STIR_INTID_WTIMER2A   ((uint32_t)0x00000062)
#define NVIC_STIR_INTID_WTIMER2B   ((uint32_t)0x00000063)
#define NVIC_STIR_INTID_WTIMER3A   ((uint32_t)0x00000064)
#define NVIC_STIR_INTID_WTIMER3B   ((uint32_t)0x00000065)
#define NVIC_STIR_INTID_WTIMER4A   ((uint32_t)0x00000066)
#define NVIC_STIR_INTID_WTIMER4B   ((uint32_t)0x00000067)
#define NVIC_STIR_INTID_WTIMER5A   ((uint32_t)0x00000068)
#define NVIC_STIR_INTID_WTIMER5B   ((uint32_t)0x00000069)
#define NVIC_STIR_INTID_SYSEXC     ((uint32_t)0x0000006A)
#define NVIC_STIR_INTID_RES123     ((uint32_t)0x0000006B)
#define NVIC_STIR_INTID_RES124     ((uint32_t)0x0000006C)
#define NVIC_STIR_INTID_RES125     ((uint32_t)0x0000006D)
#define NVIC_STIR_INTID_RES126     ((uint32_t)0x0000006E)
...
#define NVIC_STIR_INTID_RES130     ((uint32_t)0x00000072)
#define NVIC_STIR_INTID_RES131     ((uint32_t)0x00000073)
#define NVIC_STIR_INTID_RES132     ((uint32_t)0x00000074)
#define NVIC_STIR_INTID_RES133     ((uint32_t)0x00000075)
#define NVIC_STIR_INTID_RES134     ((uint32_t)0x00000076)
#define NVIC_STIR_INTID_RES135     ((uint32_t)0x00000077)
#define NVIC_STIR_INTID_RES136     ((uint32_t)0x00000078)
#define NVIC_STIR_INTID_RES137     ((uint32_t)0x00000079)
#define NVIC_STIR_INTID_RES138     ((uint32_t)0x0000007A)
#define NVIC_STIR_INTID_RES139     ((uint32_t)0x0000007B)
#define NVIC_STIR_INTID_RES140     ((uint32_t)0x0000007C)
#define NVIC_STIR_INTID_RES141     ((uint32_t)0x0000007D)
#define NVIC_STIR_INTID_RES142     ((uint32_t)0x0000007E)
#define NVIC_STIR_INTID_RES143     ((uint32_t)0x0000007F)
#define NVIC_STIR_INTID_RES144     ((uint32_t)0x00000080)
#define NVIC_STIR_INTID_RES145     ((uint32_t)0x00000081)
#define NVIC_STIR_INTID_RES146     ((uint32_t)0x00000082)
#define NVIC_STIR_INTID_RES147     ((uint32_t)0x00000083)
#define NVIC_STIR_INTID_RES148     ((uint32_t)0x00000084)
#define NVIC_STIR_INTID_RES149     ((uint32_t)0x00000085)
#define NVIC_STIR_INTID_PWM1GEN0   ((uint32_t)0x00000086)
#define NVIC_STIR_INTID_PWM1GEN1   ((uint32_t)0x00000087)
#define NVIC_STIR_INTID_PWM1GEN2   ((uint32_t)0x00000088)
#define NVIC_STIR_INTID_PWM1GEN3   ((uint32_t)0x00000089)
#define NVIC_STIR_INTID_PWM1FAULT  ((uint32_t)0x0000008A)
//---------------
typedef enum
{
    NVIC_enOK =0,
