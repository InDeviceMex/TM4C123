...
ACMP_nOUTPUT_VALUE ACMP__u32GetComparatorOutput(ACMP_nMODULE enModule, ACMP_nCOMP  enComparatorArg)
{
    ...
    enOutputValueReg = (ACMP_nOUTPUT_VALUE) ACMP__u32GetCompGeneric((uint32_t) enModule, (uint32_t) enComparatorArg, ACMP_STAT_OFFSET, ACMP_STAT_OVAL_MASK, ACMP_STAT_R_OVAL_BIT);
