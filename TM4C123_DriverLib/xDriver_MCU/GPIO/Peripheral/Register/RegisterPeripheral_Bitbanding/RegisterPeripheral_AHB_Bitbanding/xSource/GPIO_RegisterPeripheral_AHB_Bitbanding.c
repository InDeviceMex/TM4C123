...
GPIO_BITBANDING_TypeDef *GPIO_AHB_BITBANDING_BLOCK[(uint32_t) GPIO_enPORT_MAX] =
...
GPIO_AUX_BITBANDING_TypeDef *GPIO_AHB_AUX_BITBANDING_BLOCK[(uint32_t) GPIO_enPORT_MAX] =
