...
extern GPIO_BITBANDING_TypeDef *GPIO_M_BITBANDING_BLOCK[(uint32_t) GPIO_enBUS_MAX][(uint32_t) GPIO_enPORT_MAX];
extern GPIO_AUX_BITBANDING_TypeDef *GPIO_M_AUX_BITBANDING_BLOCK[(uint32_t) GPIO_enBUS_MAX][(uint32_t) GPIO_enPORT_MAX];
