...
#define GPIO    ((GPIO_APB_TypeDef*) (GPIO_BASE))
#define GPIO_AUX    ((GPIO_APB_AUX_TypeDef*) (GPIO_BASE))

extern GPIO_TypeDef *GPIO_BLOCK[(uint32_t) GPIO_enPORT_MAX];
extern GPIO_AUX_TypeDef *GPIO_AUX_BLOCK[(uint32_t) GPIO_enPORT_MAX];
