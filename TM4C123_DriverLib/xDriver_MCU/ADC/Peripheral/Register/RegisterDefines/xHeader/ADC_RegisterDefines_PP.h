...
******************************************************************************************/
/*--------*/
#define ADC_PP_R_MSR_MASK    ((uint32_t) 0x0000000FUL)
#define ADC_PP_R_MSR_BIT    ((uint32_t) 0UL)
#define ADC_PP_R_MSR_125Ksps    ((uint32_t) 0x00000001UL)
#define ADC_PP_R_MSR_250Ksps    ((uint32_t) 0x00000003UL)
#define ADC_PP_R_MSR_500Ksps    ((uint32_t) 0x00000005UL)
#define ADC_PP_R_MSR_1000Ksps    ((uint32_t) 0x00000007UL)

#define ADC_PP_MSR_MASK    ((uint32_t) 0x0000000FUL)
#define ADC_PP_MSR_125Ksps    ((uint32_t) 0x00000001UL)
#define ADC_PP_MSR_250Ksps    ((uint32_t) 0x00000003UL)
#define ADC_PP_MSR_500Ksps    ((uint32_t) 0x00000005UL)
#define ADC_PP_MSR_1000Ksps    ((uint32_t) 0x00000007UL)
/*--------*/
