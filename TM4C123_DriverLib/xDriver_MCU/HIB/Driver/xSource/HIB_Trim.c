...
HIB_nSTATUS HIB__enGetTrim(uint32_t* pu32Trim)
{
    ...
    {
        enReturn = HIB__enReadRegister(HIB_RTCT_OFFSET, pu32Trim, HIB_RTCT_TRIM_MASK, HIB_RTCT_R_TRIM_BIT);
    }
    return enReturn;
}
...
HIB_nSTATUS HIB__enSetTrim(uint32_t u32Trim)
{
    ...
    enReturn = HIB__enWriteRegister(HIB_RTCT_OFFSET, u32Trim, HIB_RTCT_TRIM_MASK, HIB_RTCT_R_TRIM_BIT);
    return enReturn;
}
