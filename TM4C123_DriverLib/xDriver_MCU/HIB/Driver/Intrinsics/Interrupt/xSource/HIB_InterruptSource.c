...
HIB_nSTATUS HIB__enEnInterruptSource(HIB_nINT enInterruptParam)
{
    ...
    enReturn = HIB__enWriteRegister(HIB_IM_OFFSET, (uint32_t) enInterruptParam, (uint32_t) enInterruptParam, 0UL);
...
HIB_nSTATUS HIB__enDisInterruptSource(HIB_nINT enInterruptParam)
{
    HIB_nSTATUS enReturn = HIB_enSTATUS_OK;
    enInterruptParam &= (uint32_t) HIB_enINT_ALL;
    enReturn = HIB__enWriteRegister(HIB_IM_OFFSET, 0UL, (uint32_t) enInterruptParam, 0UL);
...
HIB_nSTATUS HIB__enClearInterruptSource(HIB_nINT enInterruptParam)
{
    HIB_nSTATUS enReturn = HIB_enSTATUS_OK;
    enInterruptParam &= (uint32_t) HIB_enINT_ALL;
    enReturn = HIB__enWriteRegister(HIB_IC_OFFSET, (uint32_t) enInterruptParam, (uint32_t) enInterruptParam, 0UL);
...
HIB_nINT_STATUS HIB__enStatusInterruptSource(HIB_nINT enInterruptParam)
{
    ...
    enInterruptParam &= (uint32_t) HIB_enINT_ALL;
    enStatusRead = HIB__enReadRegister(HIB_RIS_OFFSET, &u32Reg, (uint32_t) enInterruptParam, 0UL);
