...
{
    WDT__vWriteRegister(enModule, WDT_CTL_OFFSET, WDT_CTL_RESEN_DIS, WDT_CTL_RESEN_MASK, WDT_CTL_R_RESEN_BIT);
}

void WDT__vSetResetOutput(WDT_nMODULE enModule, WDT_nRESET enResetOutputValue)
{
    WDT__vWriteRegister(enModule, WDT_CTL_OFFSET, (uint32_t) enResetOutputValue, WDT_CTL_RESEN_MASK, WDT_CTL_R_RESEN_BIT);
}
...
WDT_nSTATUS WDT__enGetResetOutput(WDT_nMODULE enModule, WDT_nRESET* penFeatureArg)
{
    ...
    enStatusRead = WDT__enReadRegister(enModule, (uint32_t*)penFeatureArg, WDT_CTL_OFFSET, WDT_CTL_RESEN_MASK, WDT_CTL_R_RESEN_BIT);
