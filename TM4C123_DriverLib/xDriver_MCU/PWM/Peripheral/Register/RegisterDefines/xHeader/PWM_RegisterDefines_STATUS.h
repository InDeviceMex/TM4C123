...
#define PWM_STATUS_R_FAULT0_NOOCCUR    ((uint32_t) 0x00000000UL)
#define PWM_STATUS_R_FAULT0_OCCUR    ((uint32_t) 0x00000001UL)

#define PWM_STATUS_FAULT0_MASK    ((uint32_t) 0x00000001UL)
#define PWM_STATUS_FAULT0_NOOCCUR    ((uint32_t) 0x00000000UL)
#define PWM_STATUS_FAULT0_OCCUR    ((uint32_t) 0x00000001UL)
/*--------*/

/*--------*/
#define PWM_STATUS_R_FAULT1_MASK    ((uint32_t) 0x00000002UL)
#define PWM_STATUS_R_FAULT1_BIT    ((uint32_t) 1UL)
#define PWM_STATUS_R_FAULT1_NOOCCUR    ((uint32_t) 0x00000000UL)
#define PWM_STATUS_R_FAULT1_OCCUR    ((uint32_t) 0x00000002UL)

#define PWM_STATUS_FAULT1_MASK    ((uint32_t) 0x00000001UL)
#define PWM_STATUS_FAULT1_NOOCCUR    ((uint32_t) 0x00000000UL)
#define PWM_STATUS_FAULT1_OCCUR    ((uint32_t) 0x00000001UL)
/*--------*/

/*--------*/
#define PWM_STATUS_R_FAULT2_MASK    ((uint32_t) 0x00000004UL)
#define PWM_STATUS_R_FAULT2_BIT    ((uint32_t) 2UL)
#define PWM_STATUS_R_FAULT2_NOOCCUR    ((uint32_t) 0x00000000UL)
#define PWM_STATUS_R_FAULT2_OCCUR    ((uint32_t) 0x00000004UL)

#define PWM_STATUS_FAULT2_MASK    ((uint32_t) 0x00000001UL)
#define PWM_STATUS_FAULT2_NOOCCUR    ((uint32_t) 0x00000000UL)
#define PWM_STATUS_FAULT2_OCCUR    ((uint32_t) 0x00000001UL)
/*--------*/

/*--------*/
#define PWM_STATUS_R_FAULT3_MASK    ((uint32_t) 0x00000008UL)
#define PWM_STATUS_R_FAULT3_BIT    ((uint32_t) 3UL)
#define PWM_STATUS_R_FAULT3_NOOCCUR    ((uint32_t) 0x00000000UL)
#define PWM_STATUS_R_FAULT3_OCCUR    ((uint32_t) 0x00000008UL)

#define PWM_STATUS_FAULT3_MASK    ((uint32_t) 0x00000001UL)
#define PWM_STATUS_FAULT3_NOOCCUR    ((uint32_t) 0x00000000UL)
#define PWM_STATUS_FAULT3_OCCUR    ((uint32_t) 0x00000001UL)
/*--------*/
