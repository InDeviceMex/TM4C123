...
void UART3__vIRQVectorHandler(void)
{
    ...
    if(0UL != u32RegDMAEn)
    {
        ...
        if(0UL != u32RegDMAOccur)
        {
            ...
            if(0UL == u32RegDMAPeriph)
            {
                ...
                if(DMA_DMACHMAP2_R_CH16SEL_UART3_RX == u32RegDMASource)
                {
        ...
        if(0UL != u32RegDMAOccur)
        {
            ...
            if(0UL == u32RegDMAPeriph)
            {
                ...
                if(DMA_DMACHMAP2_R_CH17SEL_UART3_TX == u32RegDMASource)
                {
    ...
    {
        UART3_UARTICR_R = (uint32_t) UART_enINT_SOURCE_CLEAR_TO_SEND;
    ...
    {
        UART3_UARTICR_R = (uint32_t) UART_enINT_SOURCE_RECEIVE;
    ...
    {
        UART3_UARTICR_R = (uint32_t) UART_enINT_SOURCE_TRANSMIT;
    ...
    {
        UART3_UARTICR_R = (uint32_t) UART_enINT_SOURCE_RECEIVE_TIMEOUT;
    ...
    {
        u32ErrorFlag = 1UL;
        UART3_UARTICR_R = (uint32_t) UART_enINT_SOURCE_FRAME_ERROR;
    ...
    {
        u32ErrorFlag = 1UL;
        UART3_UARTICR_R = (uint32_t) UART_enINT_SOURCE_PARITY_ERROR;
    ...
    {
        u32ErrorFlag = 1UL;
        UART3_UARTICR_R = (uint32_t) UART_enINT_SOURCE_BREAK_ERROR;
    ...
    {
        u32ErrorFlag = 1UL;
        UART3_UARTICR_R = (uint32_t) UART_enINT_SOURCE_OVERRUN_ERROR;
