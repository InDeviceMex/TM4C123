...
/*----------*/
#define GPWTM_CFG_R_CFG_MASK    ((uint32_t) 0x00000007UL)
#define GPWTM_CFG_R_CFG_BIT    (0UL)
#define GPWTM_CFG_R_CFG_BOTH    ((uint32_t) 0x00000000UL)
#define GPWTM_CFG_R_CFG_RTC    ((uint32_t) 0x00000001UL)
#define GPWTM_CFG_R_CFG_SINGLE    ((uint32_t) 0x00000004UL)

#define GPWTM_CFG_CFG_MASK    ((uint32_t) 0x00000007UL)
#define GPWTM_CFG_CFG_BOTH    ((uint32_t) 0x00000000UL)
#define GPWTM_CFG_CFG_RTC    ((uint32_t) 0x00000001UL)
#define GPWTM_CFG_CFG_SINGLE    ((uint32_t) 0x00000004UL)
/*----------*/
