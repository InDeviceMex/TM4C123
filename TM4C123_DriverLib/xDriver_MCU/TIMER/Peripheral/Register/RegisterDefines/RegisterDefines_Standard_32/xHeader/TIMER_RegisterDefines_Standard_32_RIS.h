...
/*----------*/
#define GPTM_RIS_R_WUERIS_MASK    ((uint32_t) 0x00010000UL)
#define GPTM_RIS_R_WUERIS_BIT    (16UL)
#define GPTM_RIS_R_WUERIS_NOACTIVE    ((uint32_t) 0x00000000UL)
#define GPTM_RIS_R_WUERIS_ACTIVE    ((uint32_t) 0x00010000UL)

#define GPTM_RIS_WUERIS_MASK    ((uint32_t) 0x00000001UL)
#define GPTM_RIS_WUERIS_NOACTIVE    ((uint32_t) 0x00000000UL)
#define GPTM_RIS_WUERIS_ACTIVE    ((uint32_t) 0x00000001UL)
/*----------*/
