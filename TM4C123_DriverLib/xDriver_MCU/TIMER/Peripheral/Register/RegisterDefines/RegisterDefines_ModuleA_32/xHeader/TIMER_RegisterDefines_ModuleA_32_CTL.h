...
#define GPWTM_TA_TnCTL_R_TnEN_ENA    ((uint32_t) 0x00000001UL)

#define GPWTM_TA_TnCTL_TnEN_MASK    ((uint32_t) 0x00000001UL)
#define GPWTM_TA_TnCTL_TnEN_DIS    ((uint32_t) 0x00000000UL)
#define GPWTM_TA_TnCTL_TnEN_ENA    ((uint32_t) 0x00000001UL)
/*----------*/
...
#define GPWTM_TA_TnCTL_R_TnOTE_ENA    ((uint32_t) 0x00000020UL)

#define GPWTM_TA_TnCTL_TnOTE_MASK    ((uint32_t) 0x00000001UL)
#define GPWTM_TA_TnCTL_TnOTE_DIS    ((uint32_t) 0x00000000UL)
#define GPWTM_TA_TnCTL_TnOTE_ENA    ((uint32_t) 0x00000001UL)
/*----------*/
