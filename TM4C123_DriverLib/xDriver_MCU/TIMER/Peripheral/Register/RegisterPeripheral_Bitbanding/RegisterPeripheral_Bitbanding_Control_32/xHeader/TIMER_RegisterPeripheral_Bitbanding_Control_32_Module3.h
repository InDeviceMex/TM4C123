...
#define GPTM3_BITBANDING_CTL    ((GPTM_BITBANDING_CTL_TypeDef*) (GPTM_BITBANDING_BASE + (GPTM3_OFFSET * 32UL)))

/******************************************************************************************
*********************************** * 1 GPTMCFG *********************************************
******************************************************************************************/
#define GPTM3_BITBANDING_CTL_GPTMCFG    ((BITBANDING_GPTMCFG_TypeDef*) (GPTM_BITBANDING_BASE + ((GPTM3_OFFSET + GPTM_CTL_GPTMCFG_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 27 GPTMPP *********************************************
******************************************************************************************/
#define GPTM3_BITBANDING_CTL_GPTMPP    ((BITBANDING_GPTMPP_TypeDef*) (GPTM_BITBANDING_BASE + ((GPTM3_OFFSET + GPTM_CTL_GPTMPP_OFFSET) * 32UL)))
