...
#define GPWTM5_CTL_BITBANDING    ((GPWTM_CTL_BITBANDING_TypeDef*) (GPWTM_BASE_BITBANDING + (GPWTM5_OFFSET * 32UL)))

/******************************************************************************************
*********************************** * 1 GPTMCFG *********************************************
******************************************************************************************/
#define GPWTM5_CTL_BITBANDING_GPTMCFG    ((BITBANDING_GPTMCFG_TypeDef*) (GPWTM_BASE_BITBANDING + ((GPWTM5_OFFSET + GPWTM_CTL_GPTMCFG_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 27 GPTMPP *********************************************
******************************************************************************************/
#define GPWTM5_CTL_BITBANDING_GPTMPP    ((BITBANDING_GPTMPP_TypeDef*) (GPWTM_BASE_BITBANDING + ((GPWTM5_OFFSET + GPWTM_CTL_GPTMPP_OFFSET) * 32UL)))
