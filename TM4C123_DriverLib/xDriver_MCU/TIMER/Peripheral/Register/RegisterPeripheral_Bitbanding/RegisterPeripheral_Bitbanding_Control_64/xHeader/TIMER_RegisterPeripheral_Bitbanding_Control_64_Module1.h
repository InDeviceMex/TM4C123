...
*********************************** * 1 CFG *********************************************
******************************************************************************************/
#define GPWTM1_BITBANDING_CTL_CFG    ((BITBANDING_GPTMCFG_TypeDef*) (GPWTM_BITBANDING_BASE + ((GPWTM1_OFFSET + GPWTM_CTL_CFG_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 27 PP *********************************************
******************************************************************************************/
#define GPWTM1_BITBANDING_CTL_PP    ((BITBANDING_GPTMPP_TypeDef*) (GPWTM_BITBANDING_BASE + ((GPWTM1_OFFSET + GPWTM_CTL_PP_OFFSET) * 32UL)))
