...
*********************************** * 1 GPTMCFG *********************************************
******************************************************************************************/
#define GPWTM4_CTL_BITBANDING_GPTMCFG    ((BITBANDING_GPTMCFG_TypeDef*) (GPWTM_BASE_BITBANDING + ((GPWTM4_OFFSET + GPWTM_CTL_GPTMCFG_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 27 GPTMPP *********************************************
******************************************************************************************/
#define GPWTM4_CTL_BITBANDING_GPTMPP    ((BITBANDING_GPTMPP_TypeDef*) (GPWTM_BASE_BITBANDING + ((GPWTM4_OFFSET + GPWTM_CTL_GPTMPP_OFFSET) * 32UL)))
