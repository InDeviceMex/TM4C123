...
void WTIMER1A__vIRQVectorHandler(void)
{
    ...
    if(0UL != u32RegDMAEn)
    {
        ...
        if(0UL != u32RegDMAOccur)
        {
            ...
            if(0UL == u32RegPeriph)
            {
                ...
                u32RegDMASource &= DMA_CHMAP1_R_CH12SEL_MASK;
                if(DMA_CHMAP1_R_CH12SEL_WTIMER1A == u32RegDMASource)
                {
    ...
    u32Reg = GPWTM1_TW_TnMIS_R;

    if((uint32_t) TIMER_enINT_TA_TIMEOUT & u32Reg)
    {
        GPWTM1_TW_TnICR_R = (uint32_t) TIMER_enINT_TA_TIMEOUT;
    ...
    {
        GPWTM1_TW_TnICR_R = (uint32_t) TIMER_enINT_TA_CAPTURE_MATCH;
    ...
    {
        GPWTM1_TW_TnICR_R = (uint32_t) TIMER_enINT_TA_CAPTURE_EVENT;
    ...
    {
        GPWTM1_TW_TnICR_R = (uint32_t) TIMER_enINT_TA_MATCH;
    ...
    {
        GPWTM1_TW_TnICR_R = (uint32_t) TIMER_enINT_TW_RTC;
    ...
    {
        GPWTM1_TW_TnICR_R = (uint32_t) TIMER_enINT_TW_WRITE_UPDATE;
