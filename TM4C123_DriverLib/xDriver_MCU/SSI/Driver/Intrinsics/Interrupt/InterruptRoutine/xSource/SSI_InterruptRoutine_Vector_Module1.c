    ...
    if(0UL != u32RegDMAEn)
    {
        ...
        if(0UL != u32RegDMAOccur)
        {
            ...
            if(0UL == u32RegPeriph)
            {
                ...
                if(DMA_CHMAP1_R_CH10SEL_SSI1_RX == u32RegDMASource)
                {
        ...
        if(0UL != u32RegDMAOccur)
        {
            ...
            if(0UL == u32RegPeriph)
            {
                ...
                u32RegDMASource &= DMA_CHMAP3_R_CH24SEL_MASK;
                if(DMA_CHMAP3_R_CH24SEL_SSI1_RX == u32RegDMASource)
                {
        ...
        if(0UL != u32RegDMAOccur)
        {
            ...
            if(0UL == u32RegPeriph)
            {
                ...
                if(DMA_CHMAP1_R_CH11SEL_SSI1_TX == u32RegDMASource)
                {
        ...
        if(0UL != u32RegDMAOccur)
        {
            ...
            if(0UL == u32RegPeriph)
            {
                ...
                if(DMA_CHMAP3_R_CH25SEL_SSI1_TX == u32RegDMASource)
                {
