...
SSI_nLENGTH SSI__enGetDataLength(SSI_nMODULE enModule)
{
    ...
    SSI__enReadRegister(enModule, SSI_SSICR0_OFFSET, &u32Reg, SSI_SSICR0_DSS_MASK, SSI_SSICR0_R_DSS_BIT);
...
{
    SSI__vWriteRegister(enModule, SSI_SSICR0_OFFSET, (uint32_t) enDataLength, SSI_SSICR0_DSS_MASK, SSI_SSICR0_R_DSS_BIT);
}
