...
void ADC0_SS3__vIRQVectorHandler(void)
{
    ...
    if(u32Reg & ((uint32_t)ADC_enSEQ_SOURCE_COMP<<(uint32_t)ADC_enSEQ_3))
    {
        ...
        if(u32RegComp & ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_0))
        {
            ...
            ADC_COMP__vIRQSourceHandler[(uint32_t)ADC_enMODULE_0][(uint32_t)ADC_enSEQ_3][(uint32_t)ADC_en_COMPARATOR_0]();
        }
        if(u32RegComp & ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_1))
        {
            ADC0_ADCDCRIC_R = ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_1);
            ADC_COMP__vIRQSourceHandler[(uint32_t)ADC_enMODULE_0][(uint32_t)ADC_enSEQ_3][(uint32_t)ADC_en_COMPARATOR_1]();
        }
        if(u32RegComp & ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_2))
        {
            ADC0_ADCDCRIC_R = ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_2);
            ADC_COMP__vIRQSourceHandler[(uint32_t)ADC_enMODULE_0][(uint32_t)ADC_enSEQ_3][(uint32_t)ADC_en_COMPARATOR_2]();
        }
        if(u32RegComp & ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_3))
        {
            ADC0_ADCDCRIC_R = ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_3);
            ADC_COMP__vIRQSourceHandler[(uint32_t)ADC_enMODULE_0][(uint32_t)ADC_enSEQ_3][(uint32_t)ADC_en_COMPARATOR_3]();
        }
        if(u32RegComp & ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_4))
        {
            ADC0_ADCDCRIC_R = ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_4);
            ADC_COMP__vIRQSourceHandler[(uint32_t)ADC_enMODULE_0][(uint32_t)ADC_enSEQ_3][(uint32_t)ADC_en_COMPARATOR_4]();
        }
        if(u32RegComp & ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_5))
        {
            ADC0_ADCDCRIC_R = ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_5);
            ADC_COMP__vIRQSourceHandler[(uint32_t)ADC_enMODULE_0][(uint32_t)ADC_enSEQ_3][(uint32_t)ADC_en_COMPARATOR_5]();
        }
        if(u32RegComp & ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_6))
        {
            ADC0_ADCDCRIC_R = ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_6);
            ADC_COMP__vIRQSourceHandler[(uint32_t)ADC_enMODULE_0][(uint32_t)ADC_enSEQ_3][(uint32_t)ADC_en_COMPARATOR_6]();
        }
        if(u32RegComp & ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_7))
        {
            ADC0_ADCDCRIC_R = ((uint32_t)1u<<(uint32_t)ADC_en_COMPARATOR_7);
            ADC_COMP__vIRQSourceHandler[(uint32_t)ADC_enMODULE_0][(uint32_t)ADC_enSEQ_3][(uint32_t)ADC_en_COMPARATOR_7]();
        }
    }
}
