...
extern GPIO_TypeDef* GPIO_BLOCK[(uint32_t)GPIO_enBUS_MAX+1u][(uint32_t)GPIO_enPORT_MAX+1u];
extern GPIO_AUX_TypeDef* GPIO_AUX_BLOCK[(uint32_t)GPIO_enBUS_MAX+1u][(uint32_t)GPIO_enPORT_MAX+1u];
