...
{
    volatile const uint32_t MINOR [8UL];
    volatile const uint32_t MAJOR [8UL];
    volatile const uint32_t CLASS [8UL];
    const uint32_t reserved [4UL];
    volatile const uint32_t VER [3UL];
    const uint32_t reserved1;
}BITBANDING_DID0_TypeDef;

typedef volatile struct
{
    volatile const uint32_t QUAL [2UL];
    volatile const uint32_t ROHS;
    volatile const uint32_t PKG [2UL];
    volatile const uint32_t TEMP [3UL];
    const uint32_t reserved [5UL];
    volatile const uint32_t PINCOUNT [3UL];
    volatile const uint32_t PARTNO [8UL];
    volatile const uint32_t FAM [4UL];
    volatile const uint32_t VER [4UL];
...
typedef volatile struct
{
    ...
    volatile uint32_t OSCSRC [2UL];
    volatile uint32_t XTAL [5UL];
...
typedef volatile struct
{
    ...
    volatile uint32_t DSOSCSRC [3UL];
    const uint32_t reserved2 [16UL];
    volatile uint32_t DSDIVORIDE [6UL];
...
typedef volatile struct
{
    ...
    const uint32_t reserved2 [19UL];
}BITBANDING_SYSPROP_TypeDef;

typedef volatile struct
{
    volatile uint32_t UT [7UL];
    const uint32_t reserved;
    volatile uint32_t UPDATE;
    volatile uint32_t CAL;
    const uint32_t reserved1 [21UL];
    volatile uint32_t UTEN;
}BITBANDING_PIOSCCAL_TypeDef;

typedef volatile struct
{
    volatile const uint32_t CT [7UL];
    const uint32_t reserved;
    volatile const uint32_t RESULT [2UL];
    const uint32_t reserved1 [6UL];
    volatile const uint32_t DT [7UL];
    const uint32_t reserved2 [9UL];
}BITBANDING_PIOSCSTAT_TypeDef;

typedef volatile struct
{
    volatile const uint32_t MINT [10UL];
    volatile const uint32_t MFRAC [10UL];
    const uint32_t reserved [12UL];
}BITBANDING_PLLFREQ0_TypeDef;

typedef volatile struct
{
    volatile uint32_t N [5UL];
    const uint32_t reserved [3UL];
    volatile uint32_t Q [5UL];
...
typedef volatile struct
{
    volatile uint32_t SRAMPM [2UL];
    const uint32_t reserved [2UL];
    volatile uint32_t FLASHPM [2UL];
...
typedef volatile struct
{
    volatile const uint32_t NOPLL [8UL];
    volatile const uint32_t WITHPLL [8UL];
...
typedef volatile struct
{
    volatile const uint32_t KHZ30 [8UL];
    volatile const uint32_t WITHPLL [8UL];
    const uint32_t reserved [16UL];
...
typedef volatile struct
{
    ...
    volatile const uint32_t PIN [3UL];
    volatile const uint32_t PORT [3UL];
...
typedef volatile struct
{
    volatile const uint32_t SRAMSZ [16UL];
    volatile const uint32_t FLASHSZ [16UL];
...
typedef volatile struct
{
    ...
    volatile const uint32_t DCMAXADC0SPD [2UL];
    volatile const uint32_t DCMAXADC1SPD [2UL];
    volatile const uint32_t DCMINSYSDIV [4UL];
...
typedef volatile struct
{
    ...
    const uint32_t reserved2 [4UL];
}BITBANDING_DC5_TypeDef;/*0x00000020*/

typedef volatile struct
{
    volatile const uint32_t DCUSB0 [2UL];
    const uint32_t reserved [2UL];
...
typedef volatile struct
{
    ...
    const uint32_t reserved2;
    volatile const uint32_t RCGCMAXADC0SPD [2UL];
    volatile const uint32_t RCGCMAXADC1SPD [2UL];
    const uint32_t reserved3 [4UL];
