...
typedef enum
{
    I2C_enSLAVE_RESQUEST_RECEIVE = 0x1UL,
    I2C_enSLAVE_RESQUEST_TRANSMIT = 0x2UL,
    I2C_enSLAVE_RESQUEST_RECEIVE_TRANSMIT = 0x3UL,
    I2C_enSLAVE_RESQUEST_FIRSTBYTE = 0x4UL,
    I2C_enSLAVE_RESQUEST_RECEIVE_FIRSTBYTE = 0x5UL,
    I2C_enSLAVE_RESQUEST_TRANSMIT_FIRSTBYTE = 0x6UL,
    I2C_enSLAVE_RESQUEST_RECEIVE_TRANSMIT_FIRSTBYTE = 0x7UL,
    I2C_enSLAVE_RESQUEST_ALTADDRESS = 0x8UL,
    I2C_enSLAVE_RESQUEST_RECEIVE_ALTADDRESS = 0x9UL,
    I2C_enSLAVE_RESQUEST_TRANSMIT_ALTADDRESS = 0xAUL,
    I2C_enSLAVE_RESQUEST_RECEIVE_TRANSMIT_ALTADDRESS = 0xBUL,
    I2C_enSLAVE_RESQUEST_FIRSTBYTE_ALTADDRESS = 0xCUL,
    I2C_enSLAVE_RESQUEST_RECEIVE_FIRSTBYTE_ALTADDRESS = 0xDUL,
    I2C_enSLAVE_RESQUEST_TRANSMIT_FIRSTBYTE_ALTADDRESS = 0xEUL,
    I2C_enSLAVE_RESQUEST_RECEIVE_TRANSMIT_FIRSTBYTE_ALTADDRESS = 0xFUL,
