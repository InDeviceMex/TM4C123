 ...
 */
#ifndef XAPPLICATION_EDUMKII_BUTTON_XHEADER_BUTTON_INIT_H_
#define XAPPLICATION_EDUMKII_BUTTON_XHEADER_BUTTON_INIT_H_
...
#endif /* XAPPLICATION_EDUMKII_BUTTON_XHEADER_BUTTON_INIT_H_ */
