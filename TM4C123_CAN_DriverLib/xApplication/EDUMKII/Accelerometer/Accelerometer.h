 ...
 */
#ifndef XAPPLICATION_EDUMKII_ACCELEROMETER_ACCELEROMETER_H_
#define XAPPLICATION_EDUMKII_ACCELEROMETER_ACCELEROMETER_H_
...
#endif /* XAPPLICATION_EDUMKII_ACCELEROMETER_ACCELEROMETER_H_ */
