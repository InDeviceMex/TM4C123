...
void EDUMKII_Led_vInitPWM(EDUMKII_nLED enLedSelect)
{
    ...
    if((uint32_t) EDUMKII_enLED_RED == ((uint32_t) enLedSelect & (uint32_t) EDUMKII_enLED_RED))
    {
        ...
        TIMER__enSetExtraModeStruct(EDUMKII_LED_RED_TIMER, &pstExtraMode);
        TIMER__enSetMode_ReloadMatch(EDUMKII_LED_RED_TIMER, TIMER_enMODE_PWM_INDIVIDUAL_HIGH_NEGATIVE_DOWN, 10240U-1U, 10240U-1U);
    ...
    if((uint32_t) EDUMKII_enLED_GREEN == ((uint32_t) enLedSelect & (uint32_t) EDUMKII_enLED_GREEN))
    {
        ...
        TIMER__enSetExtraModeStruct(EDUMKII_LED_GREEN_TIMER, &pstExtraMode);
        TIMER__enSetMode_ReloadMatch(EDUMKII_LED_GREEN_TIMER, TIMER_enMODE_PWM_INDIVIDUAL_HIGH_NEGATIVE_DOWN, 10240U-1U, 10240U-1U);
    ...
    if((uint32_t) EDUMKII_enLED_BLUE == ((uint32_t) enLedSelect & (uint32_t) EDUMKII_enLED_BLUE))
    {
        ...
        TIMER__enSetExtraModeStruct(EDUMKII_LED_BLUE_TIMER, &pstExtraMode);
        TIMER__enSetMode_ReloadMatch(EDUMKII_LED_BLUE_TIMER, TIMER_enMODE_PWM_INDIVIDUAL_HIGH_NEGATIVE_DOWN, 10240U-1U, 10240U-1U);
