...
GPIO_BITBANDING_TypeDef *GPIO_BITBANDING_BLOCK[(uint32_t) GPIO_enBUS_MAX][(uint32_t) GPIO_enPORT_MAX] =
{
...
GPIO_AUX_BITBANDING_TypeDef *GPIO_AUX_BITBANDING_BLOCK[(uint32_t) GPIO_enBUS_MAX][(uint32_t) GPIO_enPORT_MAX] =
{
