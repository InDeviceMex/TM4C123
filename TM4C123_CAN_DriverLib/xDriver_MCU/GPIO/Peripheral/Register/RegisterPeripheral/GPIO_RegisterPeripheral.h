...
extern GPIO_TypeDef *GPIO_M_BLOCK[(uint32_t) GPIO_enBUS_MAX][(uint32_t) GPIO_enPORT_MAX];
extern GPIO_AUX_TypeDef *GPIO_M_AUX_BLOCK[(uint32_t) GPIO_enBUS_MAX][(uint32_t) GPIO_enPORT_MAX];

extern uint32_t GPIO_M_BLOCK_BASE[(uint32_t) GPIO_enBUS_MAX][(uint32_t) GPIO_enPORT_MAX];
