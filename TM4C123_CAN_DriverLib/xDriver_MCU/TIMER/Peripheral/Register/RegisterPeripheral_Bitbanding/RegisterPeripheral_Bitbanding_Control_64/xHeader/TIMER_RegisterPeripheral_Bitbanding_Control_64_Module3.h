...
*********************************** * 1 CFG *********************************************
******************************************************************************************/
#define GPWTM3_CTL_BITBANDING_CFG    ((BITBANDING_GPTMCFG_TypeDef*) (GPWTM_BASE_BITBANDING + ((GPWTM3_OFFSET + GPWTM_CTL_CFG_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 27 PP *********************************************
******************************************************************************************/
#define GPWTM3_CTL_BITBANDING_PP    ((BITBANDING_GPTMPP_TypeDef*) (GPWTM_BASE_BITBANDING + ((GPWTM3_OFFSET + GPWTM_CTL_PP_OFFSET) * 32UL)))
