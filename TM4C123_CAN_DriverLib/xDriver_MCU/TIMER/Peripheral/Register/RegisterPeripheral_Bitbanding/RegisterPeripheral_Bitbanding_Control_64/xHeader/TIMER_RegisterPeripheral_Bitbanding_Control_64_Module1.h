...
#define GPWTM1_BITBANDING_CTL    ((GPWTM_BITBANDING_CTL_TypeDef*) (GPWTM_BITBANDING_BASE + (GPWTM1_OFFSET * 32UL)))

/******************************************************************************************
*********************************** * 1 GPTMCFG *********************************************
******************************************************************************************/
#define GPWTM1_BITBANDING_CTL_GPTMCFG    ((BITBANDING_GPTMCFG_TypeDef*) (GPWTM_BITBANDING_BASE + ((GPWTM1_OFFSET + GPWTM_CTL_GPTMCFG_OFFSET) * 32UL)))

/******************************************************************************************
*********************************** * 27 GPTMPP *********************************************
******************************************************************************************/
#define GPWTM1_BITBANDING_CTL_GPTMPP    ((BITBANDING_GPTMPP_TypeDef*) (GPWTM_BITBANDING_BASE + ((GPWTM1_OFFSET + GPWTM_CTL_GPTMPP_OFFSET) * 32UL)))
