...
************************************ 1 CFG *********************************************
******************************************************************************************/
#define GPWTM1_CTL_CFG    ((GPTMCFG_TypeDef*) (GPWTM1_BASE + GPWTM_CTL_CFG_OFFSET))
#define GPWTM1_CTL_CFG_R    (*((volatile uint32_t*) (GPWTM1_BASE + GPWTM_CTL_CFG_OFFSET)))

/******************************************************************************************
************************************ 27 PP *********************************************
******************************************************************************************/

#define GPWTM1_CTL_PP    ((GPTMPP_TypeDef*) (GPWTM1_BASE + GPWTM_CTL_PP_OFFSET))
#define GPWTM1_CTL_PP_R    (*((volatile uint32_t*) (GPWTM1_BASE + GPWTM_CTL_PP_OFFSET)))
