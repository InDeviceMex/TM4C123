...
/*----------*/
#define GPWTM_CTL_GPTMCFG_R_GPTMCFG_MASK    ((uint32_t) 0x00000007UL)
#define GPWTM_CTL_GPTMCFG_R_GPTMCFG_BIT    (0UL)
#define GPWTM_CTL_GPTMCFG_R_GPTMCFG_BOTH    ((uint32_t) 0x00000000UL)
#define GPWTM_CTL_GPTMCFG_R_GPTMCFG_RTC    ((uint32_t) 0x00000001UL)
#define GPWTM_CTL_GPTMCFG_R_GPTMCFG_SINGLE    ((uint32_t) 0x00000004UL)

#define GPWTM_CTL_GPTMCFG_GPTMCFG_MASK    ((uint32_t) 0x00000007UL)
#define GPWTM_CTL_GPTMCFG_GPTMCFG_BOTH    ((uint32_t) 0x00000000UL)
#define GPWTM_CTL_GPTMCFG_GPTMCFG_RTC    ((uint32_t) 0x00000001UL)
#define GPWTM_CTL_GPTMCFG_GPTMCFG_SINGLE    ((uint32_t) 0x00000004UL)
/*----------*/
