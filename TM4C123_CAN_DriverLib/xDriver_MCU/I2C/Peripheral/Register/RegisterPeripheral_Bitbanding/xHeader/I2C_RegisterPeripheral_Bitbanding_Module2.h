...
#define I2C2_BITBANDING_MCR_GFE    (*((volatile uint32_t *) (I2C_BITBANDING_BASE + ((I2C2_OFFSET + I2C_MCR_OFFSET) * 32U) + (I2C_MCR_R_GFE_BIT * 4U))))
...
*********************************** * 12 MCR2 *********************************************
******************************************************************************************/
#define I2C2_BITBANDING_MCR2    ((BITBANDING_I2CMCR2_TypeDef*) (I2C_BITBANDING_BASE + ((I2C2_OFFSET + I2C_MCR2_OFFSET) * 32U)))

#define I2C2_BITBANDING_MCR2_GFPW_0    (*((volatile uint32_t *) (I2C_BITBANDING_BASE + ((I2C2_OFFSET + I2C_MCR2_OFFSET) * 32U) + ((I2C_MCR2_R_GFPW_BIT + 0U) * 4U))))
#define I2C2_BITBANDING_MCR2_GFPW_1    (*((volatile uint32_t *) (I2C_BITBANDING_BASE + ((I2C2_OFFSET + I2C_MCR2_OFFSET) * 32U) + ((I2C_MCR2_R_GFPW_BIT + 1U) * 4U))))
#define I2C2_BITBANDING_MCR2_GFPW_2    (*((volatile uint32_t *) (I2C_BITBANDING_BASE + ((I2C2_OFFSET + I2C_MCR2_OFFSET) * 32U) + ((I2C_MCR2_R_GFPW_BIT + 2U) * 4U))))
...
#define I2C2_BITBANDING_SCSR_CONTROL_DA    (*((volatile const uint32_t *) (I2C_BITBANDING_BASE + ((I2C2_OFFSET + I2C_SCSR_OFFSET) * 32U) + (I2C_SCSR_R_DA_BIT * 4U))))
...
#define I2C2_BITBANDING_SIMR_STOPRIS    (*((volatile const uint32_t *) (I2C_BITBANDING_BASE + ((I2C2_OFFSET + I2C_SIMR_OFFSET) * 32U) + (I2C_SIMR_R_STOPRIS_BIT * 4U))))
...
#define I2C2_BITBANDING_SIMR_STOPMIS    (*((volatile const uint32_t *) (I2C_BITBANDING_BASE + ((I2C2_OFFSET + I2C_SIMR_OFFSET) * 32U) + (I2C_SIMR_R_STOPMIS_BIT * 4U))))
...
#define I2C2_BITBANDING_SIMR_STOPIC    (*((volatile uint32_t *) (I2C_BITBANDING_BASE + ((I2C2_OFFSET + I2C_SIMR_OFFSET) * 32U) + (I2C_SIMR_R_STOPIC_BIT * 4U))))
