...
#define UART6_BITBANDING_RSR_INRDC    (*((volatile const uint32_t *) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_RSR_OFFSET) * 32U) + (UART_RSR_R_INRDC_BIT * 4U))))
...
#define UART6_BITBANDING_IFLS_TXIFLSEL_3    (*((volatile uint32_t *) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_IFLS_OFFSET) * 32U) + ((UART_IFLS_R_TXIFLSEL_BIT + 3U) * 4U))))
...
#define UART6_BITBANDING_IFLS_RXIFLSEL_3    (*((volatile uint32_t *) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_IFLS_OFFSET) * 32U) + ((UART_IFLS_R_RXIFLSEL_BIT + 3U) * 4U))))
...
#define UART6_BITBANDING_ICR_CTSMIC    (*((volatile uint32_t *) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_ICR_OFFSET) * 32U) + (UART_ICR_R_CTSMIC_BIT * 4U))))
...
*********************************** * 15 9BITADDR *********************************************
******************************************************************************************/
#define UART6_BITBANDING_9BITADDR    ((BITBANDING_UART9BITADDR_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_9BITADDR_OFFSET) * 32U)))

/******************************************************************************************
*********************************** * 16 9BITAMASK *********************************************
******************************************************************************************/
#define UART6_BITBANDING_9BITAMASK    ((BITBANDING_UART9BITAMASK_TypeDef*) (UART_BITBANDING_BASE + ((UART6_OFFSET + UART_9BITAMASK_OFFSET) * 32U)))
