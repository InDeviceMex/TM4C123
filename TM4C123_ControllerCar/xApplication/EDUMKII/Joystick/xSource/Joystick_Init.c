...
void EDUMKII_Joystick_vInit(void)
{
    ...
    ADC__enSetSampleConfigGpio(ADC_enMODULE_0, ADC_enSEQ_1, ADC_en_MUX_0, &stADC0SampleConfig);
    ...
    ADC__enSetSampleConfigGpio(ADC_enMODULE_0, ADC_enSEQ_1, ADC_en_MUX_1, &stADC0SampleConfig);
