...
#define SYSEXC_BITBANDING_BASE (0x42000000)
...
#define SYSEXC_BITBANDING_SYSEXCRIS      (((BITBANDING_SYSEXCRIS_TypeDef*)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCRIS_OFFSET)*32))))
...
#define SYSEXC_BITBANDING_SYSEXCRIS_FPIDCRIS (*((volatile const uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCRIS_OFFSET)*32)+(SYSEXC_SYSEXCRIS_R_FPIDCRIS_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCRIS_FPDZCRIS (*((volatile const uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCRIS_OFFSET)*32)+(SYSEXC_SYSEXCRIS_R_FPDZCRIS_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCRIS_FPIOCRIS (*((volatile const uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCRIS_OFFSET)*32)+(SYSEXC_SYSEXCRIS_R_FPIOCRIS_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCRIS_FPUFCRIS (*((volatile const uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCRIS_OFFSET)*32)+(SYSEXC_SYSEXCRIS_R_FPUFCRIS_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCRIS_FPOFCRIS (*((volatile const uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCRIS_OFFSET)*32)+(SYSEXC_SYSEXCRIS_R_FPOFCRIS_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCRIS_FPIXCRIS (*((volatile const uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCRIS_OFFSET)*32)+(SYSEXC_SYSEXCRIS_R_FPIXCRIS_BIT*4))))
...
#define SYSEXC_BITBANDING_SYSEXCIM      (((BITBANDING_SYSEXCIM_TypeDef*)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIM_OFFSET)*32))))
...
#define SYSEXC_BITBANDING_SYSEXCIM_FPIDCIM (*((volatile uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIM_OFFSET)*32)+(SYSEXC_SYSEXCIM_R_FPIDCIM_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCIM_FPDZCIM (*((volatile uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIM_OFFSET)*32)+(SYSEXC_SYSEXCIM_R_FPDZCIM_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCIM_FPIOCIM (*((volatile uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIM_OFFSET)*32)+(SYSEXC_SYSEXCIM_R_FPIOCIM_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCIM_FPUFCIM (*((volatile uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIM_OFFSET)*32)+(SYSEXC_SYSEXCIM_R_FPUFCIM_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCIM_FPOFCIM (*((volatile uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIM_OFFSET)*32)+(SYSEXC_SYSEXCIM_R_FPOFCIM_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCIM_FPIXCIM (*((volatile uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIM_OFFSET)*32)+(SYSEXC_SYSEXCIM_R_FPIXCIM_BIT*4))))
...
#define SYSEXC_BITBANDING_SYSEXCMIS      (((BITBANDING_SYSEXCMIS_TypeDef*)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCMIS_OFFSET)*32))))
...
#define SYSEXC_BITBANDING_SYSEXCMIS_FPIDCMIS (*((volatile const uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCMIS_OFFSET)*32)+(SYSEXC_SYSEXCMIS_R_FPIDCMIS_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCMIS_FPDZCMIS (*((volatile const uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCMIS_OFFSET)*32)+(SYSEXC_SYSEXCMIS_R_FPDZCMIS_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCMIS_FPIOCMIS (*((volatile const uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCMIS_OFFSET)*32)+(SYSEXC_SYSEXCMIS_R_FPIOCMIS_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCMIS_FPUFCMIS (*((volatile const uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCMIS_OFFSET)*32)+(SYSEXC_SYSEXCMIS_R_FPUFCMIS_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCMIS_FPOFCMIS (*((volatile const uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCMIS_OFFSET)*32)+(SYSEXC_SYSEXCMIS_R_FPOFCMIS_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCMIS_FPIXCMIS (*((volatile const uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCMIS_OFFSET)*32)+(SYSEXC_SYSEXCMIS_R_FPIXCMIS_BIT*4))))
...
#define SYSEXC_BITBANDING_SYSEXCIC      (((BITBANDING_SYSEXCIC_TypeDef*)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIC_OFFSET)*32))))
...
#define SYSEXC_BITBANDING_SYSEXCIC_FPIDCIC (*((volatile uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIC_OFFSET)*32)+(SYSEXC_SYSEXCIC_R_FPIDCIC_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCIC_FPDZCIC (*((volatile uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIC_OFFSET)*32)+(SYSEXC_SYSEXCIC_R_FPDZCIC_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCIC_FPIOCIC (*((volatile uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIC_OFFSET)*32)+(SYSEXC_SYSEXCIC_R_FPIOCIC_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCIC_FPUFCIC (*((volatile uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIC_OFFSET)*32)+(SYSEXC_SYSEXCIC_R_FPUFCIC_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCIC_FPOFCIC (*((volatile uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIC_OFFSET)*32)+(SYSEXC_SYSEXCIC_R_FPOFCIC_BIT*4))))
#define SYSEXC_BITBANDING_SYSEXCIC_FPIXCIC (*((volatile uint32_t *)(SYSEXC_BITBANDING_BASE+((SYSEXC_OFFSET+SYSEXC_SYSEXCIC_OFFSET)*32)+(SYSEXC_SYSEXCIC_R_FPIXCIC_BIT*4))))
